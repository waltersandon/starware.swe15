...
\begin{tabular}{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
	...
	\midrule
	\midrule
	1.2.0 & \NDC{} & 2016-01-14 & Approvazione \\
	\midrule
	1.1.0 & \AVE{} & 2016-01-13 & Verifica correzione tabelle e consuntivo  \FA{} \\
	\midrule
	...
	\midrule
	1.0.1 & \NDC{} & 2015-12-27 &  Sistemato \mgls{template} e attività di \FA{} \\
	\midrule
...
\begin{itemize}
	\item \textbf{\FA{}:} è la prima attività, in certi aspetti la più importante, dove si delineano documenti cruciali che faranno da fondamenta per la buona riuscita del progetto come:
	\begin{itemize}
		\item \NdP{};
		\item \SdF{};
		\item \AdR{};
	...
	\end{itemize}
	\item \textbf{\FPA{}:} è la attività che segue la \RR{} dove vengono redatti i seguenti documenti:
	\begin{itemize}
		\item \ST{};
        \item \DP{}.
	\end{itemize} 
	In questa attività tutti i documenti redatti nella sezione precedente saranno eventualmente aggiornati
	\item \textbf{\FPDC{}:} è la attività che segue la \RP{} dove vengono redatti:
	\begin{itemize}
		\item Codifica;
		\item \MU{}.
	\end{itemize}
	Anche in questo caso i documenti vengono aggiornati e il tutto verificato.
	\item \textbf{\FVV{}:} subito dopo la attività di \RQ{} il prodotto viene collaudato per dimostrare che soddisfa i requisiti richiesti.
...
\newpage
\subsection{Codifica}
Ha inizio il 2016-04-12 e termina il 2016-05-16. I ruoli attivi in questa fase saranno:
\begin{itemize}
	\item \PM{};
	\item \AM{};
	\item \AN{};
...
Questa attività che ha inizio il 2016-05-16 e termina il 2016-06-10, è l'atto conclusivo di tutte le attività di verifica incontrate durante i vari cicli di progettazione. I ruoli attivi sono:
\begin{itemize}
	\item \PM{};
	\item \AM{};
	\item \PG{};
...
Qui viene proposto il sommario dei costi per fase durante tutta la fare del progetto didattico previsto.
...
\subsubsection{Rotazione dei ruoli}
Nella tabella seguente sono riportate le ore di lavoro previste per ogni membro del gruppo durante la fase di \FA.
...
\newpage
\subsubsection{Prospetto economico}
Nella tabella seguente sono riportate le ore di lavoro previste ed il loro costo per ogni ruolo durante la fase di \FA.
...
\subsubsection{Rotazione dei rouli}
Nella tabella seguente sono riportate le ore di lavoro previste per ogni membro del gruppo durante la fase di \FP.
...
\newpage
\subsubsection{Prospetto economico}
Nella tabella seguente sono riportate le ore di lavoro previste ed il loro costo per ogni ruolodurante la fase di \FP.
...
\subsubsection{Rotazione dei Ruoli}
Nella tabella seguente sono riportate le ore di lavoro previste per ogni membro del gruppo durante la fase di \FC.
...
\newpage
\subsubsection{Prospetto economico}
Nella tabella seguente sono riportate le ore di lavoro previste ed il loro costo per ogni ruolodurante la fase di \FC.
...
\subsubsection{Rotazione dei Ruoli}
Nella tabella seguente sono riportate le ore di lavoro previste per ogni membro del gruppo durante la fase di \FV.
...
\newpage
\subsubsection{Prospetto economico}
Nella tabella seguente sono riportate le ore di lavoro previste ed il loro costo per ogni ruolodurante la fase di \FV.
...
\subsubsection{Prospetto economico}
Nella tabella seguente sono riportate le differenze tra le ore di lavoro previste ed il loro costo per ogni ruolocon quelle realmente impiegate.
...
\begin{center}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{diagrammaBarreAnalisiConsuntivo.png}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l l l}
			...
			\midrule
			\TP{} & 2016-01-21 & \includegraphics[width=6cm]{firmaPigarelli.png} \\ \midrule
			\NDC{} & 2016-01-21 & \includegraphics[width=6cm]{firmaDeCao.png} \\ \midrule
			\WS{} & 2016-01-21 & \includegraphics[width=6cm]{firmaSandon.png} \\
			\bottomrule
		\end{tabular}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l l l}
            ...
            \textbf{Nominativo}	& \textbf{Data} & \textbf{Firma} \\ \midrule
			\midrule
			\RE{} & 2016-01-21 & \includegraphics[width=6cm]{firmaDeCao.png} \\ \midrule
			Docente &  & \\
		\end{tabular}
	\end{center}
\end{table}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l l l}
            ...
            \textbf{Nominativo}	& \textbf{Data} & \textbf{Firma} \\ \midrule
			\midrule
			\AVI{} & 2016-01-21 & \includegraphics[width=6cm]{firmaVitella.png} \\ \midrule
			\AVE{} & 2016-01-21 & \includegraphics[width=6cm]{firmaVenier.png} \\ \midrule
			\AB{} & 2016-01-21 & \includegraphics[width=6cm]{firmaBonaldo.png} \\ \midrule
			\IB{} & 2016-01-21 & \includegraphics[width=6cm]{firmaBaylyak.png} \\ \midrule
			\NDC{} & 2016-01-21 & \includegraphics[width=6cm]{firmaDeCao.png} \\ \midrule
			\TP{} & 2016-01-21 & \includegraphics[width=6cm]{firmaPigarelli.png} \\ \midrule
			\WS{} & 2016-01-21 & \includegraphics[width=6cm]{firmaSandon.png} \\
			\bottomrule
