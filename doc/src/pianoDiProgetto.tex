...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
		\midrule
		2.0.4 & \TP{} & 2016-05-15 & Aggiunto consuntivo \FC{} \\*
		\midrule
		2.0.3 & \TP{} & 2016-05-15 & Aggiunto riscontri rischi \FC{} \\*
		\midrule
		...
		\begin{tabular}{p{0.2\textwidth} p{0.8\textwidth}}
			...
			\textbf{Riscontro} & 
                ...
                \textbf{\FPD{}}: Non si sono riscontrati particolari ritardi causati da problemi personali. \newline
           		\textbf{\FC{}}: Alcuni membri del gruppo hanno potuto cominciare lo stage ma questo non ha causato particolari ritardi in quanto gli interessati hanno avvisato preventivamente alla formazione del gruppo. \\
			\midrule
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l r c r}
			...
			\textbf{Totale effettivo} & \textbf{202} &  & \textbf{3 486} \\ \midrule
...
\par Questo periodo ha comportato un lungo tempo per la scrittura dei test che dovrebbe semplificare l'effettivo collaudo del periodo successivo. In ogni caso non ci aspettano ne particolari ritardi ne riduzione dei costi, portandoci a completare il prodotto con il prezzo previsto inizialmente. \\
