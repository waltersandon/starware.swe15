...
Data la lunghezza del periodo di \FP\ si è deciso per motivi di efficienza e per evitare di incorrere in errori di valutazione sulla pianificazione troppo a lungo termine di spezzare il periodo con delle revisioni interne ovvero delle \mglspl{milestone}
