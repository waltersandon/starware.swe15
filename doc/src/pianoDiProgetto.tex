...
\begin{figure}[H]
    ...
    \begin{resizedtikzpicture}{\textwidth}
        \begin{ganttchart}[
            ...
            \ganttlink[link type=f-s]{elem4}{elem5}
            \ganttgroup{AD3: \PdQ{}}{2016-02-18}{2016-03-02} \\
			...
			\ganttlink[link type=f-s]{elem10}{elem11}
            \ganttgroup{AD5: \PdQ{}}{2016-03-01}{2016-03-01} \\
...
\begin{figure}[H]
    ...
    \begin{resizedtikzpicture}{\textwidth}
        \begin{ganttchart}[
            ...
            \ganttbar{PA3.1: Incremento}{2016-03-14}{2016-03-14} \\
...
\begin{itemize}
	...
	\item \textbf{\PdP{}:} Viene redatto il consuntivo e preventivo a finire per il 
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{p{0.08\textwidth} p{0.4\textwidth} p{0.2\textwidth} p{0.1\textwidth}}
			...
			\textbf{PA3} & \textbf{\PdQ{}} & &  \\ \midrule
			PD3.1 & Incremento & \RE{} & 2 \\ \midrule
			PD3.2 & Verifica & \VR{} & 2 \\ \midrule
			\bottomrule
		\end{tabular}
		\caption{Ripartizione delle risorse - \FPA{}}
	\end{center}
...
\begin{figure}[H]
    ...
    \begin{resizedtikzpicture}{\textwidth}
        \begin{ganttchart}[
            ...
            \ganttgroup{PD3: \PdQ{}}{2016-03-14}{2016-04-08} \\
            \ganttbar{PD3.1: Incremento}{2016-03-15}{2016-03-15} \\
            \ganttbar{PD3.1: Incremento}{2016-04-07}{2016-04-07} \\
            \ganttbar{PD3.2: Verifica}{2016-04-08}{2016-04-08}  \\
            \ganttlink[link type=f-s]{elem7}{elem8}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l r c r}
			...
			\textbf{Ruolo}	& \textbf{Ore} & \textbf{Costo (\euro/ora)}	& \textbf{Costo (\euro)} \\ \midrule
			\midrule
            \RE{} & 10(+6) & 30 & 300.00(+240.00) \\ \midrule
            \AM{} & 6(-2) & 20 & 120.00(-40.00) \\ \midrule
            \AN{} & 30(+20) & 25 & 750.00(+500.00) \\ \midrule
			\PG{} & & 22 & 0.00 \\ \midrule
			\PR{} & & 15 & 0.00 \\ \midrule
            \VR{} & 18(+12) & 15 & 270.00(+180.00) \\ \midrule
            \textbf{Totale effettivo} & \textbf{64} &  & \textbf{1 440.00} \\ \midrule
			\textbf{Totale preventivo} & \textbf{26} &  & \textbf{680.00} \\ \midrule
			\textbf{Differenza} & \textbf{+38} &  & \textbf{+880.00} \\ \midrule
			\bottomrule
		\end{tabular}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l r c r}
			...
			\textbf{Ruolo}	& \textbf{Ore} & \textbf{Costo (\euro/ora)}	& \textbf{Costo (\euro)} \\ \midrule
			\midrule
            \RE{} & 2 & 30 & 60.00(+0.00) \\ \midrule
			\AM{} & & 20 & 0.00 \\ \midrule
			\AN{} & & 25 & 0.00 \\ \midrule
            \PG{} & 50(-9) & 22 & 1 100.00(-198.00) \\ \midrule
			\PR{} & & 15 & 0.00 \\ \midrule
            \VR{} & 19(-1) & 15 & 285.00(-15.00) \\ \midrule
            \textbf{Totale effettivo} & \textbf{71} &  & \textbf{1 445.00} \\ \midrule
			\textbf{Totale preventivo} & \textbf{81} &  & \textbf{1 658.00} \\ \midrule
			\textbf{Differenza} & \textbf{-10} &  & \textbf{-213.00} \\ \midrule
			\bottomrule
		\end{tabular}
