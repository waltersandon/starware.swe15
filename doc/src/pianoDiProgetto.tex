...
Data la lunghezza del periodo di \FP\ si è deciso per motivi di efficienza e per evitare di incorrere in errori di valutazione sulla pianificazione troppo a lungo termine di spezzare il periodo con delle revisioni interne ovvero delle \mglspl{milestone} che hanno come obbiettivo creare una \mgls{baseline} e compiere delle misurazioni sui processi per verificarne l'efficienza, l'efficacia e la qualità. Per le metriche e la loro misurazione di veda il \PdQ\ \textit{v2.0.0}.
