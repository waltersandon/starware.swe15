...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
        \midrule
        1.1.3 & \AB{} & 2016-02-30 & Aggiunta revisione interna [aggiunta sez. \ref{sec:analisidettaglio}] \\*
		\midrule
...
Questo periodo ha inizio il 2016-02-16 e termina il 2016-03-01. I ruoli attivi in questo periodo saranno:
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{p{0.08\textwidth} p{0.4\textwidth} p{0.2\textwidth} p{0.1\textwidth}}
			...
			AD4.1 & Incremento & \RE{} & 4 \\ \midrule
			AD4.2 & Verifica & \VR{} & 2 \\ \midrule
			\textbf{AD5} & \textbf{Glossario} & &  \\ \midrule
			AD5.1 & Incremento & \VR{} & 1 \\ \midrule
			AD5.2 & Verifica & \VR{} & 1 \\
			\bottomrule
		\end{tabular}
...
\begin{center}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{../img/ganttAnalisiDiDettaglio.png}
...
Questo periodo ha inizio il 2016-03-02 e termina il 2016-04-11. I ruoli attivi in questo periodo saranno:
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{p{0.08\textwidth} p{0.4\textwidth} p{0.2\textwidth} p{0.1\textwidth}}
			...
			\textbf{PA2} & \textbf{\DP{}} & &  \\ \midrule
			PA2.1 & Stesura & \PG{} & 100 \\ \midrule
			PA2.2 & Verifica & \VR{} & 30 \\ \midrule
