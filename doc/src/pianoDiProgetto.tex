...
\begin{figure}[H]
    ...
    \begin{resizedtikzpicture}{\textwidth}
        \begin{ganttchart}[
            ...
            \ganttlink[link type=f-s]{elem1}{elem2}
            \ganttgroup{PA2: \ST{}}{2016-03-14}{2016-03-14} \\
            \ganttbar{PA2.1: Stesura}{2016-03-14}{2016-03-14} \\
        \end{ganttchart}
    \end{resizedtikzpicture}
...
\begin{figure}[H]
    ...
    \begin{resizedtikzpicture}{\textwidth}
        \begin{ganttchart}[
            ...
            \ganttbar{PD2.1: Incremento}{2016-04-06}{2016-04-06} \\
            \ganttbar{PD2.2: Verifica}{2016-04-07}{2016-04-08}
            \ganttlink[link type=f-s]{elem4}{elem5}
        \end{ganttchart}
    \end{resizedtikzpicture}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l r c r}
			...
			\textbf{Ruolo}	& \textbf{Ore} & \textbf{Costo (\euro/ora)}	& \textbf{Costo (\euro)} \\ \midrule
			\midrule
			\RE{} & 1 & 30 & 30.00 \\ \midrule
			\AM{} & & 20 & 0.00 \\ \midrule
			\AN{} & & 25 & 0.00 \\ \midrule
			\PG{} & 59 & 22 & 1 298.00 \\ \midrule
			\PR{} & & 15 & 0.00 \\ \midrule
			\VR{} & 20 & 15 & 300.00 \\ \midrule
			\textbf{Totale} & \textbf{80} &  & \textbf{1 628.00} \\
			\bottomrule
		\end{tabular}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l r c r}
			...
			\textbf{Totale} & \textbf{134} &  & \textbf{2 740.00} \\
			\bottomrule
		\end{tabular}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l r c r}
			...
			\textbf{Ruolo}	& \textbf{Ore} & \textbf{Costo (\euro/ora)}	& \textbf{Costo (\euro)} \\ \midrule
			\midrule
            \RE{} & 11(+6) & 30 & 330.00(+180.00) \\ \midrule
            \AM{} & 6(-2) & 20 & 120.00(-40.00) \\ \midrule
            \AN{} & 30(+20) & 25 & 750.00(+500.00) \\ \midrule
			\PG{} & & 22 & 0.00 \\ \midrule
			\PR{} & & 15 & 0.00 \\ \midrule
            \VR{} & 18(+10) & 15 & 270.00(+150.00) \\ \midrule
            \textbf{Totale effettivo} & \textbf{65} &  & \textbf{1 470.00} \\ \midrule
			\textbf{Totale preventivo} & \textbf{31} &  & \textbf{680.00} \\ \midrule
			\textbf{Differenza} & \textbf{+34} &  & \textbf{+790.00} \\ \midrule
			\bottomrule
		\end{tabular}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l r c r}
			...
			\textbf{Ruolo}	& \textbf{Ore} & \textbf{Costo (\euro/ora)}	& \textbf{Costo (\euro)} \\ \midrule
			\midrule
            \RE{} & 1 & 30 & 30.00(+0.00) \\ \midrule
			\AM{} & & 20 & 0.00 \\ \midrule
			\AN{} & & 25 & 0.00 \\ \midrule
            \PG{} & 51(-8) & 22 & 1 122.00(-176.00) \\ \midrule
			\PR{} & & 15 & 0.00 \\ \midrule
            \VR{} & 18(-2) & 15 & 270.00(-30) \\ \midrule
            \textbf{Totale effettivo} & \textbf{70} &  & \textbf{1 422.00} \\ \midrule
			\textbf{Totale preventivo} & \textbf{80} &  & \textbf{1 628.00} \\ \midrule
