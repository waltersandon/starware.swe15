...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
		\midrule
		3.0.3 & \TP{} & 2016-06-14 & Aggiunto consuntivo di periodo \\*
		\midrule
...
\AB{} 			& 				& 8(+2)			& 				& 				& 9(-2)			& 4(+1)			& 19(+1) \\
\midrule
\NDC{} 			& 				& 5(-1)			& 				& 6(0)			& 				& 4(-2)			& 15(-3) \\
\midrule
\TP{} 			& 6(+2)			& 				& 				& 				& 				& 10(-4)		& 16(-2) \\
\midrule
\WS{} 			& 3(+1)			& 				& 2(+2)			& 8(+1)			& 5(+5)			& 6(-3)			& 24(+6) \\
\midrule
\AVE{} 			& 3(+1)			& 				& 3(+3)			& 6(-2)			& 				& 7(-1)			& 19(+1) \\
\midrule
\AVI{} 			& 7(-1)			& 				& 				& 				& 9(0)			& 3(+2)			& 19(+1) \\
\bottomrule
		\end{tabular}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l r c r}
			...
			\textbf{Ruolo}	& \textbf{Ore} & \textbf{Costo (\euro/ora)}	& \textbf{Costo (\euro)} \\ \midrule
			\midrule	
			\RE{} & 19(+3) 	& 30 & 570.00(+90.00) \\ \midrule
			\AM{} & 17(-3)	& 20 & 340.00(-60.00) \\ \midrule
			\AN{} & 5(+5)	& 25 & 125.00(+125.00) \\ \midrule
			\PG{} & 20(-1)	& 22 & 440.00(-22.00) \\ \midrule
			\PR{} & 27(+9)	& 15 & 405.00(+135.00) \\ \midrule
			\VR{} & 41(-10)	& 15 & 615.00(-150.00) \\ \midrule
			\textbf{Totale effettivo} & \textbf{129} &  & \textbf{2 495.00} \\ \midrule
			\textbf{Totale preventivo} & \textbf{127} &  & \textbf{2 435.00} \\ \midrule
			\textbf{Differenza} & \textbf{+2} &  & \textbf{+60.00} \\ \midrule			
			\bottomrule
		\end{tabular}
...
\par Nel complesso si sono osservate un minor numero di ore per la verifica e per la stesura dei test grazie al fatto che nel periodo precedente si sono potuti scrivere una buona parte dei test necessari. Sono invece state richieste un maggior numero di ore per la programmazione e la progettazione (e relativi test) dei requisiti opzionali.

\par Il totale delle ore ha portato ad un incremento di \euro{}60.00 che sommato ai consuntivi precedenti porta il costo totale del progetto ad un risparmio di \euro{}53.00. \\

\subsubsection{Consuntivo di periodo}

\par Grazie alla solida base fornita dalla batteria di test nel periodo precedente, è stato possibile consolidare i requisiti obbligatori in poco tempo e dedicarsi anche a molti dei requisiti opzionali previsti.

\par Seguendo solo il completamento dei requisiti base, è possibile ancora intravedere l'andamento in discesa a partire dal periodo di \FPA{}. I costi aggiuntivi sono dovuti all'impiego delle risorse per completare anche i restanti requisiti in piccoli incrementi.

\par In ogni caso, grazie alla riduzione dei costi passata, è stato possibile impiegare più risorse in questo periodo e rimanere comunque sotto il costo preventivato inizialmente.

\subsubsection{Preventivo a finire}

\par Il costo totale dell'applicazione si è alzato leggermente rimanendo comunque inferiore a quanto preventivato inizialmente, risultante in \euro{}14 250.00(-53.00).

\newpage

\section{Consuntivo totale}
