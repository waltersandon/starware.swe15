...
\begin{center}
    \fileName{\textit{nomeDocumento}.pdf}
\end{center}
dove \fileName{nomeDocumento} rappresenta il nome del documento. Il documento non può contenere lettere accentate. Nel caso il nome fosse composto da più parole, la prima lettera di ogni parola, tranne la prima, deve essere maiuscola e non devono esserci spazi, \mgls{underscore} o trattini a separare le parole.
