...
Per installare \mgls{mocha} si ha bisogno del \mgls{node package manager} (npm), quindi in terminale bisogna eseguire il commando:\texttt{\$ npm install -g mocha}  
...
Quindi nel nostro caso tutti i test si trovano nella cartella starware.swe15/src/tests/ e per lanciare tutti i test bisogna eseguire il commando : \texttt{\$ mocha starware.swe15/src/tests/ --recursive
}
\newpage
