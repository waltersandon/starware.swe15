...
\midrule
\midrule
2.0.5 & \AVE & 2016-02-23 & [ modifica sez. \ref{swGestioneProgetto} ] Aggiunta norme sull'utilizzo della funzione cronometro di teamwork \\
\midrule
2.0.4 & \AVE & 2016-02-23 & [ modifica sez. \ref{Commit} ] Aggiunta esempio struttura commit \\
\midrule
2.0.3 & \AVE & 2016-02-23 & [ modifica sez. \ref{Riunioni} ] Aggiunta giorno ed orario delle riunioni\\
\midrule
2.0.2 & \AVE & 2016-02-22 & Correzione uso improprio del plurale nei processi singoli \\
\midrule
2.0.1 & \TP & 2016-02-19 & Modifica struttura directory \\
\midrule
...
\end{enumerate}
Per lo scopo del corrente progetto saranno dettate solo le norme per le fasi del fornitore e di sviluppo, poiché il processo dell'acquirente non riguardano il team e le fasi operative e di manutenzione non verranno trattate.
...
\begin{center}
	 \filePath{doc/tex/glossario.tex}
\end{center}
...
Per ogni modifica o aggiunta si deve scrivere nel \mgls{commit} le modifiche o aggiunte effettuate e le sezioni interessate dalle stesse (eg. sintassi \mgls{commit}, $[\;modifica|aggiunta\; sez.\; X,Y,...\;]\; commento\; facoltativo$ dove "X,Y,..." indicano che le sezioni di nome X,Y,... sono state aggiunte o modificate).
