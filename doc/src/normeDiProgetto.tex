...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
		1.0.12 & \TP{} & 2016-02-25 & Aggiunta sezioni su gli strumenti per la produzione di diagrammi UML TikZ-UML e Visual Paradigm [aggiunta sez. \ref{visualParadigm},\ref{TikZ-UML}]\\*
		\midrule
		1.0.11 & \TP{} & 2016-02-25 & Rimozione sezione strumenti per la produzione di diagrammi UML Drwa.io\\*
		\midrule
...
Per la modellazione dei diagrammi dei casi d'uso si è scelto di usare un \mgls{TikZ-UML} che è un estensione della libreria grafica  \mgls{TikZ} per \LaTeX{} utilizzata per la produzione di grafica vettoriale.
...
\subsubsubsection{Verifica della progettazione}
\TODO{}
