...
Per installare \mgls{mocha} si ha bisogno del \mgls{node package manager} (npm), quindi in terminale bisogna eseguire il commando: \$ npm install -g mocha 
...
\$ mocha starware.swe15/src/tests/ --recursive
\newpage
