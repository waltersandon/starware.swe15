...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
		\midrule
		3.0.3 & \IB{} & 2016-05-02 & Aggiunta sezioni sulla codifica [Aggiunta sez. \ref{code}]\\*
		\midrule
		3.0.2 & \IB{} & 2016-05-02 & Aggiunta style guide per il codice ai riferimenti informativi\\*
		\midrule
		3.0.1 & \IB{} & 2016-05-02 & Aggiunto paragrafo di mocha, strumento per testing del codice [aggiunta sez. \ref{strumentoTest}]\\*
		\midrule
...
Nell'attività di codifica i \PRpl{}, seguendo quanto specificato nella \DP{}, dovranno produrre il codice sorgente del \mgls{software} \prj{}.
...
\begin{itemize}
	...
	\item I nomi dei \mgls{package} devono avere l’iniziale maiuscola;
...
Il codice scritto per in \mgls{javascript} dovrà seguire le seguenti linee guida:
\begin{itemize}
	\item Javascript: Google JavaScript Style Guide \url{https://google.github.io/styleguide/javascriptguide.xml}.
\end{itemize}
...
Per documentare il codice \mgls{javascript} si farà uso di Jsdoc.

Ogni variabile di classe deve essere documentata quindi prima di ognuna dovrà essere presente un commento contenente:\\\\
\texttt{/**\\
...
\texttt{/**\\
	...
	* @return {{nomeValore1: tipo1, nomeValore2: tipo2, ...}} breve\\
	* descrizione dei valori di ritorno della funzione.\\
	*/\\
}
...
\mgls{mocha} è un test framework eseguito su \mgls{node.js}, supporta il lavoro con i browser, test asincroni, resoconti della copertura del prodotto con i test, e uso dei vari librerie di asserzioni.
\subparagraph{Installazione}
Per installare \mgls{mocha} si ha bisogno del \mgls{node package manager} (npm), quindi in terminale bisogna eseguire il commando:
\begin{center}
