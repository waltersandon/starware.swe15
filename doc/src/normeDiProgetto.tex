...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
		\midrule
		4.0.0 & \AVE{} & 2016-05-11 & Approvazione\\*
		\midrule
		3.1.0 & \WS{} & 2016-05-10 & Verifica\\*
		\midrule
...
È un framework di test eseguito su \mgls{node.js}, supporta il lavoro con i browser, test asincroni, resoconti della copertura del prodotto con i test, e uso dei vari librerie di asserzioni.
