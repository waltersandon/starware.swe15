...
Con la presente, il gruppo \nomeGruppo\ intende comunicarle ufficialmente la partecipazione alla \textbf{Revisione di Progettazione} (MAX) del prodotto da lei commissionato, denominato:
\begin{center}
	\textbf{\prjL}
\end{center}
...
\begin{itemize}
	...
	\item \PdP\ (\filePath{esterni/PianoDiProgetto\_v2.0.0.pdf});
	\item \PdQ\ (\filePath{esterni/PianoDiQualifica\_v2.0.0.pdf});
	\item \NdP\ (\filePath{interni/NormeDiProgetto\_v2.0.0.pdf}).
\end{itemize}

Il gruppo \nomeGruppo\ conferma la previsione della data di consegna del prodotto richiesto entro la revisione che si terrà in data \textbf{17 giugno 2016}.
