...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
		1.0.4 & \WS & 2016-05-10 & Inserimento termini Openshift e cookie \\*
		\midrule
...
>>>>>>> 9ec766b1487b75f04da872721706d76aa42d70a4
\subsection{ODM} 
...
=======
\subsection{Openshift}
è un platform as a service (PaaS) prodotto da Red Hat. OpenShift Origin, la versione gratuita ed \mgls{open-source} di OpenShift, è il progetto a monte per altre due versioni, ed è disponibile su \mgls{github}. Gli sviluppatori possono usare \mgls{git} per distribuire le applicazioni web in diverse lingue sulla piattaforma.
>>>>>>> 9ec766b1487b75f04da872721706d76aa42d70a4
\newpage
