...
\subsection{Jasmine} 
è un \mgls{framework} di sviluppo per testare codice \mgls{javascript} che non dipende da altri \mgls{framework}. Ha una sintassi pulita che permette di scrivere facilmente test. Per maggiori informazioni si veda \href{http://jasmine.github.io}{qui}.
...
\subsection{Proponente} 
 ...
 \section{Protractor}
 è un framework di test per le applicazioni \mgls{angularjs} che permette di simulare in maniera automatica le azioni di un utente attraverso l'utilizzo di browser reali.
