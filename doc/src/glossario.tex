...
\hfill\\ Attività di analisi che si avvale di test automatici.

\item[Analisi Statica]
\hfill\\ Attività di analisi che non si avvale di test automatici. Per ulteriori dettagli si veda \PdQ{}.
...
\hfill\\motore JavaScript \mgls{open-source} sviluppato da Google e scritto in C++ che  può essere eseguito stand-alone esempio in server destinati a supportare il framework Node.js.
