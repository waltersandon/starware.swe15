...
\begin{description}
    \item[URI:] L'\mgls{uri} utilizzabile per accedere alla risorsa
    \item[Metodo:] Il metodo \mgls{http} utilizzato per la richiesta
...
In alcuni casi una stessa richiesta (identificabile univocamente da \mgls{uri} e metodo) può comportarsi
