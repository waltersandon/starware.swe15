...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
		\midrule
		3.0.0 & \AVI{} & 2016-06-13 & Approvazione\\*
		\midrule
		2.1.0 & \WS{} & 2016-06-13 & Verifica\\*
		\midrule
		2.0.20 & \AVE{} & 2016-06-13 & Specificato il ruolo di server::middleware::Loader e di come risolve le sue dipendenze\\*
		\midrule
		2.0.19 & \AVE{} & 2016-06-13 & Per ridurre lo scope dei diagrammi delle classi sono stati aggiunti dei close-up delle relazioni tra i package client::controller::teacher e client::controller::student con il package client::model \\*
		\midrule
		2.0.18 & \AVE{} & 2016-06-12 & Aggiunta classe AnswerService nei diagrammi del client \\*
		\midrule
		2.0.17 & \AVE{} & 2016-06-12 & Aggiunta classi Answer, AnswerCheck e AnswerService nei diagrammi del server \\*
		\midrule
		2.0.16 & \AVE{} & 2016-06-12 & Modifica alle descrizioni dei metodi getter e setter sul client \\*
		\midrule
		2.0.15 & \AVE{} & 2016-06-10 & Incrementato il tracciamento requisiti-classi con le classi relative alle statistiche \\*
		\midrule
		2.0.14 & \TP{} & 2016-06-04 & Migliorate descrizioni getter e setter dei modelli del server come da correzione \\*
		\midrule
		2.0.13 & \TP{} & 2016-06-02 & Aggiunto attributo di tipo server::service::AnswerService al Router \\*
		\midrule
		2.0.12 & \TP{} & 2016-06-02 & Aggiunta classe server::service::AnswerService \\*
		\midrule
		2.0.11 & \TP{} & 2016-06-02 & Aggiunta classe server::data::Answer \\*
		\midrule
		2.0.10 & \TP{} & 2016-06-02 & Aggiunta parte risposte API REST \\*
		\midrule
		2.0.9 & \TP & 2016-05-31 & Inserimento immagini design pattern MVC a design pattern MVVM  \\*
		\midrule
		2.0.8 & \AVE & 2016-05-30 & Correzione del design pattern MVC a design pattern MVVM  \\*
		\midrule
		2.0.7 & \AVE & 2016-05-30 & Modifica del tipo dei campi dati dei Controller del Client da Object al tipo corretto \\*
		\midrule
		2.0.6 & \AVE & 2016-05-30 & Correzione refuso "provedde"  \\*
		\midrule
		2.0.5 & \AVE & 2016-05-30 & Approfondimenti descrizione classi Service del Server\\*
		\midrule
		2.0.4 & \TP & 2016-05-30 & Approfondimenti descrizione classi Service del Client \\*
		\midrule
		2.0.3 & \TP & 2016-05-30 & Modifica della visibilità dei campi dati pubblici, vengono resi privati \\*
		\midrule
		2.0.2 & \TP & 2016-05-30 & Aggiunta figura 6 \\*
		\midrule
		2.0.1 & \TP & 2016-05-27 & Aggiornato nell'API REST il fatto che la visualizzazione domande, questionari e argomenti è ora pubblico \\*
		\midrule
		2.0.0 & \AVE & 2016-05-14 & Approvazione \\*
		\midrule
		1.1.3 & \NDC & 2016-05-14 & Verifica \\*
		\midrule
		1.1.2 & \AVE & 2016-05-13 & Verifica \\*
		\midrule
		1.1.1 & \TP & 2016-05-12 & Verifica \\*
		\midrule
		1.1.0 & \AVI & 2016-05-12 & Verifica \\*
		\midrule
		1.0.13 & \NDC{} & 2016-05-11 & Aggiunta sezione Async.js, SimpleMDE markdown editor\\*
		\midrule
		1.0.12 & \AVE{} & 2016-05-11 & Aggiunta sezione panoramica dell'architettura \\*
		\midrule
		1.0.11 & \NDC{} & 2016-05-10 & Aggiunta sezione per spiegare come si integrano le librerie e i framework nell'applicazione \\*
		\midrule
		1.0.10 & \AVI{} & 2016-05-08 & Controllo, ampliamento ed aggiunta diagrammi di sequenza \\*
		\midrule
		1.0.9 & \AVE{} & 2016-05-05 & Rimozione analisi database NoSql in quanto trattato nel capitolo di MongoDB \\*
		\midrule
		1.0.8 & \AVE{} & 2016-05-05 & Aggiunta analisi criticità delle tecnologie adottate \\*
		\midrule
...
\begin{itemize}
    \item \textbf{Specifica \mgls{html5}}: \url{https://www.w3.org/TR/html5};
    \item \textbf{Specifica \mgls{css3}}: \url{https://www.w3.org/TR/css3-roadmap};
    \item \textbf{Documentazione \mgls{node.js}}: \url{https://nodejs.org/en/docs};
    \item \textbf{Documentazione \mgls{express}}: \url{http://expressjs.com/en/guide/routing.html};
    \item \textbf{Documentazione \mgls{mongodb}}: \url{https://docs.mongodb.org/manual};
    \item \textbf{Documentazione \mgls{mongoose}}: \url{http://mongoosejs.com/docs/guide.html};
    \item \textbf{Documentazione \mgls{angularjs}}: \url{https://docs.angularjs.org/api};
    \item \textbf{Documentazione \mgls{bootstrap}}: \url{http://getbootstrap.com/css};
    \item \textbf{Documentazione async.js}: \url{https://github.com/caolan/async};
    \item \textbf{Documentazione SimpleMDE markdown editor}: \url{https://github.com/NextStepWebs/simplemde-markdown-editor}.
\end{itemize}
...
\end{itemize}
Tuttavia gli aspetti positivi hanno fatto propendere il gruppo ad adottare questo \mgls{framework}.

\subsubsubsection{Integrazione nel sistema}
\mGls{node.js} verrà quindi impiegato per la realizzazione del \mgls{server} di \prj{}.
...
\end{itemize}
\mgls{angularjs} verrà impiegato sia per la creazione dell'interfaccia grafica sia per la business logic del \mgls{front-end}.

\subsubsubsection{Integrazione nel sistema}
Il \mgls{framework} \mgls{angularjs} verrà utilizzato per costruire tutto il  \mgls{front-end}. Tutta l'interfaccia utente è costruita con il modello \mgls{mvc} e \mgls{angularjs} fornisce metodi e funzionalità per costruire questo tipo di interfacce. Infatti tutte le classi in \texttt{client::controller} sono costruite attraverso i metodi che \mgls{angularjs} fornisce per istanziare controllers. Inoltre \mgls{angularjs} permette la creazione di servizi (i quali vengono istanziati come singleton e attraverso dependency injection richiamati dove serve) e di factories (le quali permettono di costruire oggetti e attraverso dependency injection che vengano richiamati dove serve). I servizi verranno utilizzati per la realizzazione di tutti i componenti in \texttt{client::model::service} e \texttt{client::util}. Le factories verranno utilizzare per la realizzazione di tutti i componenti in \texttt{client::model:data}.
...
\subsubsubsection{Integrazione nel sistema}
Verranno utilizzate le classi CSS fornite da \mgls{bootstrap} per la composizione di ogni pagina del \mgls{front-end} del nostro sistema. Quindi tutti i componenti in \texttt{client::view} utilizzeranno \mgls{bootstrap}.

\subsubsection{Express}\label{express}
\mgls{express} è un \mgls{framework} minimale che aiuta ad organizzare le applicazioni web create con \mgls{node.js}.

\subsubsubsection{Integrazione nel sistema}
\mgls{express} viene installato come un modulo di \mgls{node.js} e lo integra, fornendo una migliore implementazione del sistema di \mgls{routing}, incrementando le funzioni di richiesta e risposta estendendole per una maggior flessibilità, integrando nuovi \mgls{middleware}, ed agevolando la realizzazione delle \mglspl{vista}. \mgls{express} aiuta l'utente a gestire le \mgls{route}, le \mgls{request} e le \mgls{view}. \mgls{express},oltre che per il \mgls{routing} delle richieste e risposte, verrà utilizzato per definire l'ordine dei \mgls{middleware} nella \textit{chain of responsability} (vedere sezione Descrizione Design Pattern \ref{descrizioneDesignPattern}) ed in fine per restituire al \mgls{client} le risposte \mgls{http} con gli eventuali errori riscontrati dal \mgls{server}. Dato che \mgls{express} integra le funzionalità di \mgls{node.js} gli aspetti potenzialmente critici sono gli stessi elencati nella sezione \ref{node.js}.

\subsection{Librerie}\label{librery}
\subsubsection{Mongoose}\label{mongoose}
Per questo progetto è stato scelto di utilizzare \mgls{mongoose}, attualmente il più diffuso \mgls{odm}. Questa libreria permette di definire degli schemi per modellare i dati del database, imponendo una certa struttura per la creazione di nuovi \mgls{Document}. Inoltre, fornisce molti strumenti utili per la validazione dei dati, per la definizione di \mgls{query} e per il cast dei tipi predefiniti. La documentazione di \mgls{mongoose} è ben fornita e descrive le \mgls{api} in maniera esaustiva, fornendo degli \mgls{snippet} del codice sorgente. Non sono state trovati particolari aspetti critici introdotti dall'utilizzo di \mgls{mongoose}.

\subsubsubsection{Integrazione nel sistema}
\mgls{mongoose} viene installato come un modulo \mgls{node.js} e viene utilizzato nel \mgls{server} di \prj{} per definire il modello che i dati dovranno avere per essere salvati nel \mgls{database}. Questa libreria è particolarmente utile in quanto permette di lanciare automaticamente delle funzioni \mgls{javascript}, costruite ad-hoc, per verificare che i dati rispettino tutte le caratteristiche desiderate. 

\subsubsection{Async.js}\label{asyncjs}
Async è un modulo di utilità che fornisce funzioni per lavorare in modo asincrono con \mgls{javascript}. Questo modulo è stato originariamente sviluppato per funzionare con \mgls{node.js} ed è installabile attraverso il \mgls{node package manager}, inoltre è utilizzabile direttamente tramite \mgls{browser}. Async fornisce circa una settantina di funzionalità (\texttt{map, reduce, filter, parallel, series, waterfall, ...}). Tutte queste funzionalità per funzionare correttamente devono essere utilizzate assumendo di seguire le convenzioni di \mgls{node.js} (es. bisogna fornire una singola callback come ultimo argomento della funziona asincrona).

\subsubsubsection{Integrazione nel sistema}
Viene utilizzato nella parte \mgls{client} per svolgere alcune operazioni che richiedono l'esecuzione di richieste asincrone come l'utilizzo delle \mgls{api} \mgls{rest}.

\subsubsection{SimpleMDE markdown editor}\label{simpleMDE}
SimpleMDE markdown editor è una libreria che provvede a fornire un editor \mgls{markdown} semplice da usare e comodo per gli utenti. Si integra perfettamente con \mgls{javascript} e permette di costruire un editor \mgls{wysiwyg} che permette agli utenti meno esperti di familiarizzare con il linguaggio \mgls{markdown} attraverso un'interfaccia grafica e degli shortcuts.

\subsubsubsection{Integrazione nel sistema}
SimpleMDE markdown editor viene utilizzato per costruire l'editor che permette ai docenti di scrivere le domande in \mgls{qml}. L'editor inoltre permette la visualizzazione di un'anteprima di quello che verrà poi visualizzato dagli studenti.
...
\subsubsubsection{Integrazione nel sistema}
\mGls{mongodb} verrà quindi impiegato per la realizzazione del database sul \mgls{server} di \prj{}.

\newpage
\section{Standard di progetto}

\subsection{Denominazione di entità e relazioni}
Entità e relazioni devono avere nomi chiari e concisi. È preferibile utilizzare sostantivi per le entità e verbi per le relazioni. Per ulteriori informazioni si vedano le \NdPv.

\subsection{Documentazione del codice}
Gli standard relativi alla documentazione del codice sono specificati in \NdPv.

\subsection{Strumenti di lavoro}
Gli strumenti da adottare e le procedure da seguire per utilizzarli correttamente durante la realizzazione  del prodotto software sono definiti in \NdPv.

\newpage
\section{Panoramica dell'architettura}
Nella seguente figura viene illustrata l'architettura che si è scelto di adottare per sviluppare l'applicazione \prj{}.
Si è scelto di disaccoppiare il più possibile il  \mgls{client} dal \mgls{server} trattandoli come entità totalmente separate, dove la comunicazione tra le parti avviene attraverso \mgls{api} \mgls{rest} facendo richieste \mgls{http} e ricevendo come risposte oggetti \mgls{json}.
\begin{center}
	\begin{figure}[H]
		\centering
		\includegraphics[max width=\textwidth]{../img/diagrammiClassi/clientServerGeneral.png}
...
\subsubsection{MVC}
\paragraph{Scopo} 
Questo pattern è utilizzato per separare le responsabilità dell’applicazione a diversi componenti e permettere di fare una chiara divisione tra presentazione, struttura dei dati e operazioni su di essi;
\paragraph{Utilizzo}
Viene utilizzato nel livello \mgls{client} per separare i componenti a seconda delle loro responsabilità e secondo una connotazione semantica. Il formalismo che viene quindi assunto per dividere i \mgls{package} è proprio quello fornito dal pattern in questione e cioè: \mgls{model}, \mgls{view} e \mgls{controller}. Questi però non interagiscono tra di loro nella maniera canonica che il pattern offre, ma seguono lo stile proposto da MVVM descritto alla sezione \ref{mvvm}.
...
\subsubsection{MVVM} \label{mvvm}
\paragraph{Scopo}
Questo pattern è utilizzato per separare le responsabilità dell'applicazione a diversi componenti e permettere di fare una chiara divisione tra presentazione, struttura dei dati e operazioni su di essi.

\paragraph{Utilizzo}

Nel \mgls{front-end} viene utilizzato questo \mgls{design pattern} per dividere la presentazione e lo sviluppo dell'interfaccia grafica dell'applicazione dalla \textit{business logic}. I vari componenti sono identificati nelle seguenti classi:

\begin{itemize}
	\item il \mgls{package} \texttt{client::model::data} è il modello dei dati;
	\item il \mgls{package} \texttt{client::model::service} sono i servizi di \textit{business logic};
	\item il \mgls{package} \texttt{client::view} è la \textit{presentation logic} che costruisce le pagine da visualizzare attraverso la proiezione del modello;
	\item il \mgls{package} \texttt{client::controller} espone i metodi dell'\textit{application logic}.
\end{itemize}
...
\section{Descrizione Design Pattern}\label{descrizioneDesignPattern}
\subsection{Design Pattern Architetturali}
\subsubsection{MVC}
...
\begin{figure}[H]	
	\centering
	\includegraphics[width=1.0\linewidth]{../img/MVC.png}
	\caption{Disign pattern MVC push model}
	\label{Disign pattern MVC push model}
\end{figure}
...
\subsubsection{MVVM}
	\begin{figure}[H]	
		\centering
		\includegraphics[width=1.0\linewidth]{../img/MVVM.png}
		\caption{Disign pattern MVVM}
		\label{Disign pattern MVVM}
	\end{figure}
Model View View-Model (MVVM) è una variante del pattern \mgls{mvc}. Questo pattern propone un ruolo più attivo della \mgls{view} rispetto a \mgls{mvc}: la \mgls{view} è in grado di gestire eventi, eseguire operazioni ed effettuare il data-binding. In questo contesto, quindi, alcune delle funzionalità del \mgls{controller} vengono inglobate nella \mgls{view}, la quale si
appoggia su un’estensione del \mgls{model}: il ViewModel. Il ViewModel è quindi un \mgls{model} esteso con funzionalità per la manipolazione dei dati e per l’interazione con la \mgls{view};
Questo pattern ha un impatto positivo nella progettazione di interfacce utente e viene implementato in modo semplice da \mgls{angularjs}.
Il pattern MVVM è consigliato qualora si voglia separare interamente la progettazione dell’interfaccia grafica dalla \textit{business logic} dell’applicazione;
...
\begin{itemize}
	...
	\item aggiunge flessibilità nell'assegnamento delle responsabilità degli oggetti: è possibile distribuire le responsabilità tra gli oggetti a runtime modificandone la gerarchia. Staticamente è possibile usare il |\mgls{subclassing} per specializzare i gestori;
