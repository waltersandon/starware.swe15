...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
		\midrule
		2.0.18 & \AVE{} & 2016-06-13 & Per ridurre lo scope dei diagrammi delle classi sono stati aggiunti dei close-up delle relazioni tra i package client::controller::teacher e client::controller::student con il package client::model \\*
		\midrule
		2.0.17 & \AVE{} & 2016-06-12 & Aggiunta classe AnswerService nei diagrammi del client \\*
		\midrule
		2.0.16 & \AVE{} & 2016-06-12 & Aggiunta classi Answer, AnswerCheck e AnswerService nei diagrammi del server \\*
		\midrule
		2.0.15 & \AVE{} & 2016-06-12 & Modifica alle descrizioni dei metodi getter e setter sul client \\*
		\midrule
		...
		\midrule
		2.0.9 & \WS & 2016-05-31 & Inserimento immagini design pattern MVC a design pattern MVVM  \\*
		\midrule
