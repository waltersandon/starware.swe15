...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
		0.0.15 & \IB{} & 2016-04-05 & Aggiunta classi server \\*
		\midrule
		0.0.14 & \WS{} & 2016-04-01 & Aggiunta classi server \\*
		\midrule
		0.0.13 & \AB{} & 2016-03-25 & Aggiunta classi server \\*
		\midrule
		0.0.12 & \NDC{} & 2016-03-22 & Aggiunta classi server \\*
		\midrule
...
\paragraph{Utilizzo}
Express usa chain of Responsibility per la gestione dei middleware e del routing. Come già accennato è particolarmente legato al pattern Middleware. Viene utilizzato nella nostra architettura all’interno del package Server::middleware. La classe Server::middleware::Router gestisce la richiesta scorrendo tutta la lista delle sottoclassi e richiamando il metodo next finché una di queste non può soddisfarla. Nel gergo del framework Express i middleware corrispondono agli oggetti ConcreteHandler del design pattern. Sebbene il comportamento e lo scopo sia quasi identico, l’implementazione di Express presenta alcune differenze:
