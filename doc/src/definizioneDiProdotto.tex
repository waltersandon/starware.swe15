...
Async è un modulo di utilità che fornisce funzioni per lavorare in modo asincrono con \mgls{javascript}. Questo modulo è stato originariamente sviluppato per funzionare con \mgls{node.js} ed è installabile attraverso il \mgls{node package manager} ed è utilizzabile direttamente da \mgls{browser}.
