...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
		\midrule
		2.0.2 & \TP & 2016-05-28 & Aggiornato nell'API REST il fatto che la visualizzazione domande, questionari e argomenti è ora pubblico \\*
		\midrule
		2.0.1 & \TP & 2016-05-27 & Aggiunto campo spiegazione alle domande nell'API REST \\*
		\midrule
		...
		\midrule
		1.0.8 & \AVE{} & 2016-05-05 & Aggiunta analisi criticità delle tenologie adottate \\*
		\midrule
