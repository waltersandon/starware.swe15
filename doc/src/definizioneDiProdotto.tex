...
Si è scelto di disaccoppiare il più possibile il  \mgls{client} dal \mgls{server} trattandoli come entità totalmente separate, dove la comunicazione tra le parti avviene attraverso le \mgls{api} \mgls{rest} trasmettendo richieste e risposte \mgls{http} e oggetti \mgls{json}.
\begin{center}
	\begin{figure}[H]
		\centering
