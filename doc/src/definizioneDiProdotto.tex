...
\subsection{Inserisci Domanda}
Di seguito viene presentato il diagramma di sequenza per la rimozione di un questionario da parte di un docente.

\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheightfour, angle=90]{../img/diagrammiSequenza/inserisciDomandaServer.png}
		\caption{Diagramma sequenza - Inserisci Domanda Server}
	\end{figure}
\end{center}

\newpage
\subsection{Inserisci Questionario}
\TODO{desc}

\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheighttwo, angle=90]{../img/diagrammiSequenza/inserisciQuestionarioServer.png}
...
\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheighttwo, angle=90]{../img/diagrammiSequenza/loginServer.png}
...
\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheighttwo, angle=90]{../img/diagrammiSequenza/modificaDomandaServer.png}
...
\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheighttwo, angle=90]{../img/diagrammiSequenza/modificaQuestionarioServer.png}
...
\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheighttwo, angle=90]{../img/diagrammiSequenza/registrazioneServer.png}
		\caption{Diagramma sequenza - Registrazione Server}
	\end{figure}
\end{center}

\newpage
\subsection{Rimozione Domanda}
\TODO{desc}

\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheighttwo, angle=90]{../img/diagrammiSequenza/rimozioneDomandaServer.png}
		\caption{Diagramma sequenza - Rimozione Domanda Server}
	\end{figure}
\end{center}

\newpage
\subsection{Rimozione Questionario}
\TODO{desc}

\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheighttwo, angle=90]{../img/diagrammiSequenza/rimozioneQuestionarioServer.png}
...
\subsection{Cambio Informazioni}
...
\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheightthree, angle=90]{../img/diagrammiSequenza/cambioInfoClient.png}
...
\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheighttwo, angle=90]{../img/diagrammiSequenza/cambioPasswordClient.png}
...
\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheighttwo, angle=90]{../img/diagrammiSequenza/inserisciQuestionarioClient.png}
...
\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheighttwo, angle=90]{../img/diagrammiSequenza/modificaQuestionarioClient.png}
...
\begin{center}
	\begin{figure}[H]
		\centering \includegraphics[max width=\myheighttwo, angle=90]{../img/diagrammiSequenza/rimozioneQuestionarioClient.png}
