...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \umlactor[x=0, y=12]{Microsoft}
        \umlactor[x=0, y=9]{Facebook}
        \umlactor[x=0, y=6]{Google}
        \umlactor[x=0, y=3]{Utente}
        \umlactor[x=0, y=0]{Ospite}

        \umlactor[x=4, y=6]{Studente}
        \umlactor[x=4, y=3]{Docente}
        \umlactor[x=4, y=0]{Amministratore}

        \umlactor[x=8, y=0]{Proprietario}

        \umlinherit{Studente}{Utente}
...
\begin{itemize}
    ...
    \item \textbf{Google:} attore che rappresenta il servizio OAuth2 per l'autenticazione attraverso account
        Google
    \item \textbf{Facebook:} attore che rappresenta il servizio di autenticazione attraverso account
        Facebook
    \item \textbf{Microsoft:} attore che rappresenta il servizio di autenticazione attraverso account 
        Window Live
\end{itemize}
