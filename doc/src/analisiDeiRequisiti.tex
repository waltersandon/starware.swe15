...
\begin{center}
	\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
		...
		\midrule
		3.0.2 & \AVE{} & 2016-05-28 & Aggiunti use case per lo svolgimento e l'inserimento di due nuove tipologie di domande (tolleranza numerica e ordinamento) dopo una review ed aggiunti i requisiti associati \\*
		\midrule
		3.0.1 & \AVE{} & 2016-05-26 & Modificato attore dei casi d'uso (e casi d'uso figli) di ricerca ed esecuzione questionari dopo una review con il proponente \\*
		\midrule
