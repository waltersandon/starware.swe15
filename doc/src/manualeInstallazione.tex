...
\begin{document}
	...
	\begin{itemize}
		\item \textbf{Piattaforme supportate da \mgls{node.js}}: \url{https://nodejs.org/en/download/} 
		\item \textbf{Piattaforme supportate da \mgls{mongodb}}: \url{https://www.mongodb.com/download-center}
	\end{itemize}
	...
	su \mgls{github} e disponibile al seguente indirizzo: \url{https://github.com/lordnikolai/starware.swe15}
	...
	\begin{enumerate}
		...
		\item \texttt{git clone https://github.com/protechunipd/SGAD.git} provvederà al download del prodotto nella cartella corrente. \TODO{che repo è ?}
	\end{enumerate}
	...
	Vengono forniti script appositi per facilitare l'installazione dell'applicativo. 
		...
		\begin{center}
				\texttt{>chmod win\_setup \\
					>chmod win\_start	 \\
					>./win\_setup} \\
				\TODO{non so se esistono questi comandi sotto win}
		\end{center}
