...
\begin{document}
	...
	\begin{itemize}
		\item \textbf{Piattaforme supportate da Node.js}: \url{https://nodejs.org/en/download/} 
		\item \textbf{Piattaforme supportate da MongoDB}: \url{https://www.mongodb.com/download-center}
	\end{itemize}
