...
\newcommand{\dataCreazione}{30 aprile 2016}
...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{center}
			\texttt{\$ npm install} 
		\end{center}
		\item su una seconda Shell (assicurandosi di non chiuderla fino a quando si desidera utilizzare l'applicazione), avviare il \mgls{database} \mgls{mongodb} con il comando:
		\begin{center}
			\texttt{\$ mongod} 	
		\end{center}	
