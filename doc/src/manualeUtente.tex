...
\end{itemize}
	...
	\begin{itemize}
		...
		\item selezionare il pulsante "@todo-submit". 
	\end{itemize}
...
\end{figure}
	...
	\begin{itemize}
		...
		\item selezionare sul pulsante "@todo-submit" per confermare la modifica.
	\end{itemize}
	\begin{figure}[h]	
		\centering
	...
	\begin{itemize}
		...
		\item selezionare il pulsante "@todo-submit" per confermare la modifica.
	\end{itemize}
	\begin{figure}[h]
		\centering
	...
	Una volta inserito il \mgls{qml}, selezionare il pulsante "@todo" in basso a destra.
	
	Se il \mgls{qml} inserito non è valido, l'applicazione chiederà di correggere il \mgls{qml} inserito e di selezionare nuovamente il pulsante "@todo".
	...
	\par Una volta modificata la domanda, premere il pulsante "@todo-submit" in basso a destra per confermare le modifiche effettuate. Con il pulsante "@todo-cancel" si annulla l'operazione. \\
	...
	\par Selezionando la voce "Gestione argomenti" dal menu a lato, sotto la voce "Docente", vengono visualizzati gli argomenti precedentemente creati da qualsiasi altro utente.
		...
		\begin{itemize}
			...
			\item selezionare "@todo-submit" per confermare la creazione del argomento.
		\end{itemize}
		...
		\par Una volta terminata la compilazione, selezionando il pulsante "@todo-submit", sarà possibile confermare la creazione. 
		In ogni momento sarà possibile annullare l'operazione di creazione del questionario selezionando "@todo-cancel".
		...
		\par Una volta terminata la modifica, selezionando la voce "@todo-submit" sarà possibile confermare le modifiche. In ogni momento sarà possibile annullare l'operazione premendo il pulsante "@todo-cancel". \\
