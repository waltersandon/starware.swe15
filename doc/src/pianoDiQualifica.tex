...
\begin{document}
	...
	\begin{center}
		\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
			...
			\midrule
			\midrule
			2.0.3 & \AB & 2016-05-10 & Modifica metrica Cost of Poor Quality\\*
			\midrule
...
\section{Dettaglio Analisi}\TODO{modifica titolo}
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabular}{p{0.4\textwidth} p{0.2\textwidth} p{0.3\textwidth}}
				...
				\mgls{milestone schedule variance}  &1.5\%& Superato\\ \midrule
				\mgls{schedule variance} &4.22\% & Superato \\ \midrule 
