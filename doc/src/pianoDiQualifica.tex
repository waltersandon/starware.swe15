...
\begin{document}
	...
	\begin{center}
		\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
			...
			4.0.0 & \WS & 2016-05-14 & Approvazione\\*
			\midrule
			3.1.0 & \TP & 2016-05-14 & Verifica\\*
			\midrule
			3.0.7 & \AB & 2016-05-13 & Aggiunta report delle modifiche fatte ai documenti in seguito all'RQ\\*
			\midrule
			3.0.6 & \AB & 2016-05-13 & Incremento sui risultati dei test\\*
			\midrule
			3.0.5 & \AB & 2016-05-13 & Ristrutturazione metrica sul numero di campi dati per classe\\*
			\midrule
			3.0.4 & \AB & 2016-05-13 & Incremento delle metriche sul software\\*
			\midrule
			3.0.3 & \AB & 2016-05-14 & Incremento delle metriche sui processi\\*
			\midrule
	...
	\begin{longtable}{r l p{10cm} l l}
		...
		\end{enumerate} & R-3F9 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F31 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F16 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F7.11.1 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F7.11.2 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F7.11.3 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F7.7 & P\tabularnewline
		\midrule
		...
		\begin{enumerate}
			...
			\item conferma modifica.
		\end{enumerate} & R-3F7.12 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F7.13 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F22.1 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F22.3 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F22.2 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F11.2 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F11.1 & P\tabularnewline
		\midrule
		...
		\begin{enumerate}
			...
			\item conferma modifica.
		\end{enumerate} & R-3F13.3 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F13.2 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F17 & P\tabularnewline
		\midrule
		...
		\end{enumerate} & R-3F32 & P\tabularnewline
		\midrule
		...
		\begin{enumerate}
			...
			\item specifica parametri di filtraggio dei risultati;
			\item visualizzazione elenco.
		\end{enumerate} & R-3F22.4 & P\tabularnewline
		\midrule
		...
		\begin{enumerate}
			...
			\item specifica parametri di filtraggio dei risultati;
			\item visualizzazione elenco.
		\end{enumerate} & R-3F19 & P\tabularnewline
		\midrule
		...
		\begin{enumerate}
			...
			\item specifica parametri di filtraggio dei risultati;
			\item visualizzazione elenco.
		\end{enumerate} & R-3F14 & P\tabularnewline
		\midrule
		& TV22 & Verifica che il docente sia in grado di visualizzare una domanda attraverso i passi seguenti: \begin{enumerate} \item selezione della domanda; \item visualizzazione dati domanda. \end{enumerate} & R-3F29 & P\tabularnewline
		\midrule
		& TV23 & Verifica che il docente sia in grado di visualizzare un questionario attraverso i passi seguenti: \begin{enumerate} \item selezione del questionario; \item visualizzazione dati e elenco domande questionario. \end{enumerate} & R-3F30 & P\tabularnewline
		\midrule
		&TV24&Verifica che un ospite sia in grado di eseguire un questionario attraverso i seguenti passi: \begin{enumerate} \item ricerca questionario; \item selezione questionario; \item compilazione questionario; \item conferma compilazione; \item visualizzazione dei risultati. \end{enumerate} & 	R-2F24 & P\tabularnewline \midrule
	...
	\begin{longtable}{l p{9cm} l l}
		...
		\midrule
		TS7.5.1.2 & Viene verificato che il QML permetta l'inserimento di immagini & P & \hypertarget{R-3F7.5.1.2}{R-3F7.5.1.2}\tabularnewline
		\midrule
		TS7.5.1.6 & Viene verificato che il QML permetta di definire vari tipi di domanda & P & \hypertarget{R-3F7.5.1.6}{R-3F7.5.1.6}\tabularnewline
		\midrule
		...
		\midrule
		TS7.5.5 & Viene verificato che Il QML possa gestire risposte vero/falso, risposte a scelta multipla, possa contenere testi e immagini	 & P & \hypertarget{R-3F7.5.5}{R-3F7.5.5}\tabularnewline
		\midrule
		...
		\midrule
		TS7.11.1.2.1 & Viene verificato che il sistema sia in grado di verificare l'inserimento di QML valido e, in caso contrario, segnalare un errore & P & \hypertarget{R-3F7.11.1.2.1}{R-3F7.11.1.2.1}\tabularnewline
		\midrule
		...
		\midrule
		TS7.11.1.2.4 & Viene verificato che il docente possa inserire domande di tipo scelta multipla & P & \hypertarget{R-1F7.11.1.2.4}{R-1F7.11.1.2.4}\tabularnewline
		\midrule
		TS7.12 & Viene verificato che sia possibile per un docente modificare un questionario che ha precedentemente creato & P & \hypertarget{R-3F7.12}{R-3F7.12}\tabularnewline
		\midrule
		TS7.13 & Viene verificato che sia possibile per un docente eliminare un questionario che ha precedentemente creato & P & \hypertarget{R-3F7.13}{R-3F7.13}\tabularnewline
		\midrule
		...
		\midrule
		TS9 & Viene verificato che sia possibile per ogni tipo di utente registrarsi presso il sistema & P & \hypertarget{R-3F9}{R-3F9}\tabularnewline
		\midrule
		TS9.1 & Viene verificato che il sistema consenta le funzionalità utente solo se possiede un proprietario & P & \hypertarget{R-3F9.1}{R-3F9.1}\tabularnewline
		\midrule
		...
		\midrule
		TS9.2.1 & Viene verificato che il sistema segnali un errore se non vengono inseriti tutti i campi necessari alla registrazione di un utente & P & \hypertarget{R-3F9.2.1}{R-3F9.2.1}\tabularnewline
		\midrule
		...
		\midrule
		TS14 & Viene verificato che, per ogni tipo di utente, il sistema gestisca correttamente la ricerca di un questionario da parte di un utente & P & \hypertarget{R-3F14}{R-3F14}\tabularnewline
		\midrule
		...
		\midrule
		TS18 & Viene verificato che il sistema consenta e gestisca correttamente tutte le azioni previste per il proprietario & P & \hypertarget{R-3F18}{R-3F18}\tabularnewline
		\midrule
		...
		\midrule
		TS22 & Viene verificato che sia possibile per un docente, amministratore e proprietario la gestione degli argomenti presenti nel sistema & P & \hypertarget{R-3F22}{R-3F22}\tabularnewline
		\midrule
		...
		\midrule
		TS30 & Viene verificato che il sistema consenta ad un docente di visualizzare un questionario & P & \hypertarget{R-3F30}{R-3F30}\tabularnewline 	\midrule 
	...
	\begin{longtable}{l p{8cm} l l}
		...
		\midrule
		TI.10 & Viene verificato che l'integrazione tra i package model::date e  model::service  sia corretta & model & P\tabularnewline
		\midrule
		...
		\midrule
		TI.15 & Viene verificato che student riceva le risposte attese dal package model::data & student & P\tabularnewline
		\midrule
	...
	\begin{center}
		\begin{longtable}[]{l l p{0.4\textwidth} c}\midrule
			...
			TU.559&   AnswerService& get()  & P\\ \midrule
			TU.560&   AnswerService& new()  & P\\ \midrule
	...
	\begin{center}
		\begin{longtable}[H]{l p{0.1\textwidth}p{0.30\textwidth} p{0.25\textwidth} c}\midrule
			...
			TU.197& user&  Welcome& Welcome()  & P\\ \midrule
	...
	\begin{center}
		...
		\end{longtable}
	\end{center}
	\subsubsection{Package \texttt{client:model:data}: test e tracciamento}
	Per ogni unità \mgls{software} qui definita, devono essere verificati i seguenti punti:
	
	\begin{itemize}
		\item che i costruttori inizializzino correttamente i campi dati;
		\item che i metodi getter e setter funzionino correttamente;
		\item che i metodi di controllo rilevino gli errori ricercati;
	\end{itemize}
	\begin{center}
		\begin{longtable}[H]{l p{0.3\textwidth} p{0.45\textwidth} c}\midrule
			\textbf{ID} & \textbf{Classe} & \textbf{Metodo} & \textbf{Stato}\\ \midrule
			\midrule		
			TU.132& CurrentQuestionnaire &checkAnswers() & P\\ \midrule
			TU.282& CurrentQuestionnaire &getCurrentNumber() & P\\ \midrule
			TU.131& CurrentQuestionnaire &getPrevious() & P\\ \midrule		
			TU.130& CurrentQuestionnaire &getNext() & P\\ \midrule	
			TU.283& CurrentQuestionnaire &getQuestionNumber() & P\\ \midrule	
			TU.284& CurrentQuestionnaire &getQuestions() & P\\ \midrule	
			TU.209& CurrentQuestionnaire &getResult() & P\\ \midrule
			TU.281& CurrentQuestionnaire &getTags() & P\\ \midrule		
			TU.285& CurrentQuestionnaire &getTitle() & P\\ \midrule	
			TU.409& CurrentQuestionnaire &setCurrentNumber() & P\\ \midrule
			TU.410& CurrentQuestionnaire &setQuestionNumber() & P\\ \midrule	
			TU.411& CurrentQuestionnaire &setQuestions() & P\\ \midrule	
			TU.408& CurrentQuestionnaire &setTags() & P\\ \midrule
			TU.412& CurrentQuestionnaire &setTitle() & P\\ \midrule
			TU.279& CurrentQuestion &getAnswer() & P\\ \midrule	
			TU.492& CurrentQuestion &getAnswers() & P\\ \midrule	
			TU.278& CurrentQuestion &getBody() & P\\ \midrule	
			TU.493& CurrentQuestion &getSelectedAnswer() & P\\ \midrule	
			TU.280& CurrentQuestion &getType() & P\\ \midrule	
			TU.206& CurrentQuestion &point() & P\\ \midrule	
			TU.406& CurrentQuestion &setAnswer() & P\\ \midrule	
			TU.494& CurrentQuestion &setAnswers() & P\\ \midrule	
			TU.405& CurrentQuestion &setBody() & P\\ \midrule	
			TU.495& CurrentQuestion &setSelectedAnswer() & P\\ \midrule	
			TU.407& CurrentQuestion &setType() & P\\ \midrule	
	...
	\begin{center}
		\begin{longtable}[]{p{0.125\textwidth} p{0.3\textwidth} p{0.5\textwidth} p{0.05\textwidth}}
			...
			TU.554 & AnswerService& get()  & P\\ \midrule	
			TU.555 & AnswerService& getByID()  & P\\ \midrule
			TU.556 & AnswerService& new()  & P\\ \midrule
		\end{longtable}
	\end{center}	
	...
	\begin{center}
		\begin{longtable}[H]{l p{0.45\textwidth} p{0.3\textwidth} c}\midrule
			...
			TU.561 & AnswerCheck & AnswerCheck()  & P\\ \midrule	
			TU.562 & AnswerCheck& checkScore()  & P\\ \midrule
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabular}{p{0.4\textwidth} p{0.2\textwidth} p{0.3\textwidth}}
				\midrule
				\textbf{Indice}   & \textbf{Valore}	& \textbf{Esito test} \\ \midrule  \midrule
				\mGls{cost variance} & -3.8\% & Superato\\ \midrule
				\mgls{schedule variance} & 9\%& Non Superato \\ 
				\midrule
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabular}{p{0.4\textwidth} p{0.2\textwidth} p{0.3\textwidth}}		\midrule
				...
				\midrule
				MSV formula generale & 1.2\% & Superato \\ \midrule 
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabular}{p{0.3\textwidth} l l l}
				\midrule
				\textbf{Metrica} & \textbf{Superato} & \textbf{Ottimale} & \textbf{ Non superato} \\ \midrule\midrule
				\# campi dati/ classe & 80\% & 20\% & 0\% \\\midrule
				\# campi dati/ classe "service"& 100\% & 0\% & 0\% \\\midrule
				\# parametri/metodo & 98\% & 2\% & \% \\\midrule
				\mgls{complessità ciclomatica} & 99.8\% & 0.2\% & 0\% \\\midrule
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabular}{p{0.4\textwidth} p{0.3\textwidth} p{0.2\textwidth}}
				...
				Copertura da parte dei test & 92.5\%  & Ottimale \\ \midrule
			\end{tabular}	
		\end{center}
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabular}{l l l l l ll}
				...
				SV&0.5\%[Acc]& 167\% [NA] & 12\% [NA]& 0\% [Ott] & 0.95\% [Acc] &9\% [NA] \\\midrule
				CV &0\% [Ott]&-157\% [NA] & -12\% [NA]& 0\% [Ott] & -0.5\% [Acc] & 3.8\%[Acc] \\\midrule
				MSV &--& 80\%&[NA]  4\% [Acc]& 0\% [Ott] & 3.22\% [Acc] & 1.2\% [Acc] \\\midrule
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabular}{l l l l l ll}
				...
				Campi dati/classe  & [Sup] & [NonSup] & [Sup] \\
				\midrule
				Campi dati/classe "service" & ** & ** & [Ott]
				\\\midrule
				Parametri/metodo  & [Ott]&  [Ott] & [Ott] \\\midrule
				Instabilità  & -- & [Ott] & [Ott] \\\midrule
				Compl.Ciclomatica  & -- & [Ott] & [Sup] \\\midrule
				Copertura Test  & -- & [Ott] & [Ott] \\\midrule
				\# linee codice/metodo & -- & [Ott] & [Ott] \\\midrule
				Annidamento  & -- & [Ott] & [Ott] \\\bottomrule
			\end{tabular}	
		\end{center}
		\caption{Riepilogo sulle misurazioni della qualità del prodotto \mgls{software}}
	\end{table}
	
	Nella tabella soprastante sono riportati i risultati complessivi relativi alla qualità del prodotto software.
	I risultati, per maggiore leggibilità sono riassunti come:
	\begin{itemize}
		\item \textbf{[Ott]} se i risultati rientrano nel range ottimale nel 100\% dei casi;
		\item \textbf{[Sup] }se i risultati rientrano nel range ottimale o accettabile nel 100\% dei casi;
		\item\textbf{ [NonSup]} se almeno per qualche caso i risultati non rientrano nel range accettabile;
		\item \textbf{**} se la metrica non risulta definita durante una fase attraversata;
		\item \textbf{--} se la metrica non risulta inerente al prodotto della fase attraversata.
	...
	\begin{itemize}
		\item \textbf{Generale}: 
		\item \textbf{\DP{}:} modificata la visibilità degli attributi delle classi in privata. Corretta figura 6, prima mancante. Chiarito il ruolo delle classi Service per Client e Server. Eliminati i diagrammi delle classi View, sostituiti da una descrizione più generale. Approfondita la descrizione delle classi service del client, fornendo indicazioni su quali servizi REST vengano invocati. Modificati i tipi degli attributi nelle classi interne al package Controller, prima segnati di tipo Object. Descritto nel dettaglio l'utilizzo delle direttive Angular. Modificatta la descrizione del design pattern MVC in MVVM. Sepatata inoltre la descrizione e le immagini
		del design pattern dalla sua implementazione nel progetto.   
		\item \textbf{\PdP{}:} 
		\item \textbf{\PdQ{}:} E' stata inserita una sezione di riepilogo sui risultati di analisi statica e dinamica. La sezione relativa ai test è stata spostata in appendice.
		\item \textbf{\GL{}:} Modificati i bookmark nel documento pdf per renderli funzionanti. 
		\item \textbf{Manuali:} creato un glossario apposito per i manuali forniti.
		\item \textbf{\MU{}:} Sono state inserite maggiori informazioni per l'utente relative all'interfaccia QML e maggiori informazioni relative al linguaggio Markdown. 
		...
		\item \textbf{\textit{Manuale installazione}:} corretto refuso "MondoDB". Arricchito il documento con nuovi screenshot che possano guidare l'utente meno esperto. Eliminato supporto a versioni future dei framework. Aggiunte indicazioni per l'utilizzo dei pacchetti di installazione ora forniti. 
	\end{itemize}
