...
\begin{document}
	...
	\paragraph{Test di Integrazione}
	   ...
	   \[ TI.[componete]\]
	   dove la sigla TI si riferisce a un test di integrazione, [componente] viene sostituito dalla macrocomponente di cui si verifica l'integrrazione.
	\paragraph{Test di Unità}
		...
		\begin{itemize}
			...
			\item \textbf{Success:} test implemantato superato
...
\subsubsection{Definizione dettagliata}
	...
	\subsubsection{Definizione dettagliata dei test}
	\begin{longtable}{l p{6cm} l l}
		\midrule
