...
\[CV [\%] = \frac{EV - AC}{EV}\]
Dove CV indica \mgls{cost variance}, EV (Earned Value) è il valore in euro delle \mgls{attivita} realizzate alla data corrente e AC (Actual Cost) equivale ai costi effettivamente sostenuti alla data corrente.
...
\TODO{ho modificato signIn con signUp e non so se usare il monospace per i package}
\begin{table}[H]
	\begin{center}
...
Il modello \mgls{spice} definisce 6 possibili livelli di maturità del processo i quali possiedono
...
\end{itemize}
Non avendo la possibilità di testare la qualità in uso del prodotto \mgls{software} da sviluppare, si è deciso di concentrarsi sulla qualità interna ed esterna. Lo\textit{Standard ISO/IEC 9126}
...
\end{table}
\TODO{FORSE DA SCRIVERE I METODI NON ACCETTABILI}
...
\begin{itemize}
	...
	\TODO{CHE UNA PERSONA SOLA REDIGA I VERBALI è CONTRO LE NORME}
