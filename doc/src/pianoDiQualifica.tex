...
\begin{document}
	...
	\begin{center}
		\begin{longtable}[H]{p{0.12\textwidth} p{0.2\textwidth} p{0.18\textwidth} p{0.39\textwidth}}
			...
			\midrule
			\midrule
			2.0.2 & \AB & 2016-05-10 & Integrazione sezione \ref{metriche}\\*
			\midrule
			\midrule
			2.0.2 & \AB & 2016-05-10 & Modifica metrica Cost of Poor Quality\\*
			\midrule
...
\begin{center}
		\begin{longtable}[]{p{0.14\textwidth} p{0.325\textwidth} p{0.5\textwidth} p{0.025\textwidth}}
	\textbf{Id} & \textbf{metodo} & \textbf{descrizione} & P\\ \midrule
...
\section{Dettaglio delle verifiche tramite analisi}\TODO{modifica titolo}
	...
	\begin{table}[!h]
			...
			\begin{tabular}{p{0.4\textwidth} p{0.2\textwidth} p{0.3\textwidth}}		\midrule
				...
				CoPQ codice & 5\% &  Ottimale \\ \midrule
