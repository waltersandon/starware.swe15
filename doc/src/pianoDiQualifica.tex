...
\begin{center}
	\begin{longtable}[H]{l p{0.45\textwidth} p{0.35\textwidth} c}\midrule
	...
	193.193.TU& public: \newline  Home.checkLogged() & should have a method to check if the path is active & P\\ \midrule
	193.193.TU& public: \newline  Home.urlPath() & should have a method to check if the path is active & P\\ \midrule
...
176.79.TU	& teacher: \newline  ManipulateQuestionnaire. \newline ManipulateQuestionnaire() & deve creare il questionnario  & P\\ \midrule
	195.195.TU & user: Home.logout() & it should filter the list of roles \\ \midrule
...
\subsubsection{\texttt{server:validator}}
\begin{center}
		\begin{longtable}[H]{l p{0.45\textwidth} p{0.3\textwidth} c}\midrule
			\textbf{ID} & \textbf{Metodo} & \textbf{Descrizione} & \textbf{Stato}\\ \midrule
			\midrule
			164. 42.TU & validator: \newline QuestionCheck.checkQML() & deve bloccare QML TF senza risposta0 mspasseddeve bloccare QML MultipleChoice senza risposta giusta, deve bloccare QML MultipleChoice senza risposte, deve bloccare QML MultipleChoice con due risposte giuste, deve accettare QML come corpo della domanda, deve accettare QML per domanda vero/falso, deve accettare QML per domanda a risposta multipla & P \\ \midrule
			162.179.TU & validator: \newline QuestionCheck.checkTags() & deve bloccare domande con la lista dei tag vuote, deve bloccare domande con la lista dei tag duplicati, deve accettare domande con la lista dei tag distinti & P \\ \midrule
			162.40.TU & validator: \newline QuestionnaireCheck.checkTitile() & deve bloccare il titolo vuoto, deve accettare il titolo non vuoto & P \\ \midrule
			162.180.TU & validator: \newline QuestionnaireCheck.checkTags() & deve bloccare la lista dei tag vuota, deve accettare la lista dei tag non vuota & P \\ \midrule
			162.39.TU & validator: \newline QuestionnaireCheck.checkQuestions() & deve bloccare passata lista vuota, deve bloccare passata lista con domande doppie, deve accettare passata lista corretta & P \\ \midrule
			163.41.TU & validator: \newline TagCheck.checkName() & deve bloccare name vuoto, deve accettare name non vuoto & P \\ \midrule
			161.38.TU & validator: \newline UserCheck.checkFullName() & deve bloccare i full name di lungezza 1 carattere, deve accettare i full name di lungezza 3 caratteri & P \\ \midrule
			161.37.TU & validator: \newline UserCheck.checkPassword() & deve accettare password di lungezza 6 caratteri, deve accettare password di lungezza 8 caratteri, deve bloccare password di lungezza 2 caratteri & P \\ \midrule
			161.36TU & validator: \newline UserCheck.username() & deve accettare password di lungezza 6 caratteri, deve accettare password di lungezza 8 caratteri, deve bloccare password di lungezza 2 caratteri & P \\ \midrule
