...
Il package \texttt{server::service} e le relative classi vengono testate tramite le \mgls{api} REST corrispondenti, seguendo le metodologie usualmente utilizzate per il test di classi back-end di questo tipo.
\begin{center}
