	...
	\begin{table}[H]
		\begin{center}
			\begin{tabular}{p{0.4\textwidth} p{0.3\textwidth} p{0.3\textwidth}}
				...
				Manuale Sviluppatore \TODO{} &  46 & Superato  \\ \midrule
		...
		\begin{table}[H]
			\begin{center}
				\begin{tabular}{p{0.35\textwidth} p{0.2\textwidth} p{0.15\textwidth}p{0.15\textwidth}}
					\midrule
						\textbf{metrica} & \textbf{\% accettabile} & \textbf{\%ottima} & \textbf{\%non acc} \\ \midrule\midrule
						...
						instabiltà &  &  &  \\\midrule
						copertura da parte dei test &  &  &\\ \midrule
				\end{tabular}	
			\end{center}
