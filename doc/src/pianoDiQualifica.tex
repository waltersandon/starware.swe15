	...
	I valori percentuali indicano la quantità di righe di codice sul totale che rientrano nel range indicato.
		...
		\begin{table}[H]
			\begin{center}
				\begin{tabular}{p{0.4\textwidth} p{0.2\textwidth} p{0.3\textwidth}}
					...
					\mgls{schedule variance}  & \%& \\ 
					\midrule
					\mgls{requirement stability index}  & \% &  \\
					\bottomrule
				\end{tabular}	
			\end{center}
		...
		\begin{table}[H]
			\begin{center}
				\begin{tabular}{p{0.4\textwidth} p{0.2\textwidth} p{0.3\textwidth}}		\midrule
					\textbf{MSV dettagliato}   & \textbf{Valore}	& \textbf{Esito test} \\ \midrule  \midrule
					MSV medio per persona & \%& \\ \midrule
					MSV medio per gruppo  & \%& \\ 
					\midrule
					MSV formula generale & \% &  \\ \midrule 
					
				\end{tabular}	
			\end{center}
			\caption{Dettaglio 	\mgls{milestone schedule variance} in fase   \FV}
		\end{table}
		\subparagraph{Analisi dei risultati} \TODO{analisi dei risultati}
		\paragraph{Cost of Poor Quality}
		...
		\begin{center}
			\begin{table}[!h]
				...
				\begin{tabular}{p{0.5\textwidth} p{0.1\textwidth} p{0.3\textwidth}}		\midrule
					\textbf{CoPQ}   & \textbf{Valore}	& \textbf{Esito test} \\ \midrule  \midrule
					\CoPQ{}   documenti & \% &  \\ \midrule
					\CoPQ{}  progettazione & \% & \\ \midrule
					\CoPQ{} codice & \% &   \\ \midrule\midrule
					\textbf{	\CoPQ{} medio} & \textbf{\%} & \textbf{}  \\ \midrule 				
				\end{tabular}	
		...
		\begin{table}[H]
			\begin{center}
				\begin{tabular}{p{0.4\textwidth} p{0.3\textwidth} p{0.2\textwidth}}
					...
					\DP & &   \\ \midrule
					\MU &  &  \\ \midrule
					Manuale Installazione &   &   \\ \midrule
					Manuale Sviluppatore  &  &   \\ \midrule
					\GL &   &  \\ \midrule \midrule
		...
		\begin{table}[H]
			\begin{center}
				\begin{tabular}{p{0.3\textwidth} l l l}
					...
					\# linee codice/metodo & \% & \% & \% \\\midrule
					\# livelli annidamento & \% & \% & \% \\\midrule
		...
		\begin{table}[H]
			\begin{center}
				\begin{tabular}{p{0.2\textwidth}l l l l ll}
					\midrule
					...
					MSV &--& 80\%&[NA]  4\% [Acc]& 0\% [Ott] & 3.22\% [Acc] & \% \\\midrule
					CoPQ &--& 23\% & 40\% & 21\% & 24\% & \% \\\midrule
					RSI &--& 81\% & 94\% & 91\% & 100\% & \% \\\midrule\midrule
		...
		\subsubsection{Analisi statica su documentazione}\TODO{completare fase  \FV}
		\begin{table}[H]
			\begin{center}
				\begin{tabular}{p{0.2\textwidth}l l l l ll}
					\midrule
					\textbf{Metrica} & \textbf{FA}  & \textbf{FAD}& \textbf{FPA} & \textbf{FPD}  & \textbf{ FC } & \textbf{ FV } \\ \midrule\midrule
					Gulpease &51.6 [Ott]& 51.6 [Ott]& 51.7 [Ott]& 53.5 [Ott]& 51.4 [Ott] &  \\\midrule
		...
		\begin{table}[H]
			\begin{center}
				\begin{tabular}{p{0.3\textwidth}l l l l ll}
					...
					Instabilità  & -- & 0.20 & \% \\\midrule
					Compl.Ciclomatica  & -- & 100\% & \% \\\midrule
					Copertura Test  & -- & 76.1\% & \% \\\midrule
					\# linee codice/metodo & -- & -- & 100\% & \% \\\midrule
					Annidamento  & -- & 100\% & \% \\\bottomrule
				\end{tabular}	
			\end{center}
		...
		\begin{table}[H]
			\begin{center}
				...
				\textbf{	Test di sistema}& 100\% & \% & \% & \% \\\midrule
				\textbf{	Test di validazione} & 100\% & \% & \% & \% \\\midrule
