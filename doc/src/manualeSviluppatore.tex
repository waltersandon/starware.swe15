...
\begin{document}
	...
	\begin{itemize}
		...
		\item \mgls{jetbrains} \mgls{idea}:  \url{https://www.jetbrains.com/idea/};
		\item \mgls{jetbrains} \mgls{webstorm}: \url{https://www.jetbrains.com/webstorm/}.
	\end{itemize}
	...
	\subsection{Comunicazione malfunzionamenti}
		...
		all’indirizzo:	\url{starware.swe@gmail.com}. Nella mail di segnalazione si dovranno riportare:
		\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Inserire in \textbf{Parent Directory} il percordo alla cartella locale che conterrà la cartella della \mgls{repository} che verrà clonata; 
		\item Inserire in \textbf{Directory Name} il nome desiderato per la cartella nella quale verrà clonata la \mgls{repository};
