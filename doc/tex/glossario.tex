...
\newglossaryentry{scope}{
	name=scope,
	plural=scopes,
	description={ Lo scope è un oggetto di \mgls{angularjs} che rappresenta il contesto in cui vengono salvati i dati di un’applicazione (il model) ed in cui vengono valutate le espressioni utilizzate nella \mgls{view}.}
}
...
\newglossaryentry{mean stack}{
	name=M.E.A.N. Stack,
	description={ Il M.E.A.N. Stack è l'insieme di \mgls{mongodb}, \mgls{express}, \mgls{angularjs}, \mgls{node.js}. }
}
