...
\newglossaryentry{controller} {
	name=controller,
	description={E' un componente del pattern MVC. Il controller si occupa di mandare comandi al model per modificarne lo stato ed inoltre controlla costantemente la sua view associata per verificare se vi sono stati input o comandi dall'utente}
}
