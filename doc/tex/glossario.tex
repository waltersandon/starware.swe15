...
\newglossaryentry{mocha}{
	name=mocha,
	description={ Mocha è un framework di test su \mgls{javascript} ricco di funzionalità, in esecuzione su Node.js o nel browser , rende test asincroni semplici  e divertenti .I test sono eseguiti in serie , consentendo il reporting della copertura del prodotto dai test flessibile e preciso.}
}

\newglossaryentry{utf-8}{
	name=UTF-8,
	description={ UTF-8 (Unicode Transformation Format, 8 bit) è una codifica dei caratteri Unicode in sequenze di lunghezza variabile di byte. }
}

\newglossaryentry{bom}{
	name=BOM,
	description={ Il Byte Order Mark (BOM) è una piccola sequenza di byte che viene posizionata all'inizio di un flusso di dati di puro testo (tipicamente un file) per indicarne il tipo di codifica Unicode.}
}

\newglossaryentry{scope}{
	name=scope,
	plural=scopes,
	description={è un oggetto di \mgls{angularjs} che rappresenta il contesto in cui vengono salvati i dati di un’applicazione (il model) ed in cui vengono valutate le espressioni utilizzate nella \mgls{view}.}
}
...
\newglossaryentry{mean stack}{
	name=M.E.A.N. Stack,
	description={è l'insieme di \mgls{mongodb}, \mgls{express}, \mgls{angularjs}, \mgls{node.js}. }
}

\newglossaryentry{openshift}{
	name=Openshift,
	description={è un platform as a service (PaaS) prodotto da Red Hat. OpenShift Origin, la versione gratuita ed \mgls{open-source} di OpenShift, è il progetto a monte per altre due versioni, ed è disponibile su \mgls{github}. Gli sviluppatori possono usare \mgls{git} per distribuire le applicazioni web in diverse lingue sulla piattaforma.}
}

\newglossaryentry{cookie}{
	name=cookie,
	plural=cookies,
	description={I cookie \mgls{http} sono una sorta di gettone identificativo, usato dai server web per poter riconoscere i \mgls{browser} durante comunicazioni con il protocollo \mgls{http} usato per la navigazione web. }
}



\newglossaryentry{cost of poor quality}{
	name=Cost of poor quality,
	description={indica al management aziendale l’inefficienza di processi non buoni valutando il costo delle \mgls{attivita} di correzione che seguono la verifica}
}

\newglossaryentry{requirement stability index}{
	name=Requirement Stability Index,
	description={indica quanto variano i requisiti nel tempo.}
}

\newglossaryentry{complessità ciclomatica}{
	name=complessità ciclomatica,
	description={misura la complessità del programma contando il numero di cammini linearmente indipendenti attraverso il grafo di controllo di flusso. Valori troppo alti implicano una ridotta manutenibilità del codice, valori troppo bassi potrebbero determinare scarsa efficienza dei metodi.}
}

\newglossaryentry{jetbrains}{
	name=JetBrains,
	description={JetBrains (ex IntelliJ) è un'azienda di sviluppo software ceca nata nel 2000 i cui strumenti hanno come mercato gli sviluppatori software e i project manager.}
}

\newglossaryentry{idea}{
	name=IDEA,
	description={IntelliJ IDEA è un ambiente di sviluppo integrato (IDE) per il linguaggio di programmazione Java.}
}

\newglossaryentry{webstorm}{
	name=WebStorm,
	description={IntelliJ Webstorm è un ambiente di sviluppo integrato (IDE) per lo sviluppo Web.}
}

\newglossaryentry{ide}{
	name=IDE,
	description={in lingua inglese Integrated Development Environment ovvero IDE, anche integrated design environment o integrated debugging environment, rispettivamente ambiente integrato di progettazione e ambiente integrato di debugging. E' un software che, in fase di programmazione, aiuta i programmatori nello sviluppo del codice sorgente di un programma.}
}

\newglossaryentry{plugin}{
	name=plugin,
	description={è un programma non autonomo che interagisce con un altro programma per ampliarne o estenderne le funzionalità originarie. Ad esempio, un plugin per un software di grafica permette l'utilizzo di nuove funzioni non presenti nel software principale.}
}

\newglossaryentry{shell}{
	name=shell,
	description={la shell è la parte di un sistema operativo che permette agli utenti di interagire con il sistema stesso, impartendo comandi e richiedendo l'avvio di altri programmi.}
}

\newglossaryentry{markdown}{
	name=markdown,
	description={è un linguaggio di markup con una sintassi del testo semplice progettata in modo che possa essere convertita in HTML e in molti altri formati.}
}

\newglossaryentry{wysiwyg}{
	name=WYSIWYG,
	description={è l'acronimo che sta per l'inglese What You See Is What You Get (quello che vedi è quello che è) e si riferisce al'utilizzo di editor di testo o grafici che a schermo fanno vedere esattamente quello che verrà poi visualizzato all'utente finale.}
}

\newglossaryentry{protractor}{
	name=Protractor,
	description={è un framework di test per le applicazioni \mgls{angularjs} che permette di simulare in maniera automatica le azioni di un utente attraverso l'utilizzo di browser reali.}
}

\newglossaryentry{jasmine} {
	name=jasmine,
	description={è un \mgls{framework} di sviluppo per testare codice \mgls{javascript} che non dipende da altri \mgls{framework}. Ha una sintassi pulita che permette di scrivere facilmente test. Per maggiori informazioni si veda \href{http://jasmine.github.io}{qui}}
}
