...
\newglossaryentry{wysiwyg}{
	name=WYSIWYG,
	description={WYSIWYG è l'acronimo che sta per l'inglese What You See Is What You Get (quello che vedi è quello che è) e si riferisce al'utilizzo di editor di testo o grafici che a schermo fanno vedere esattamente quello che verrà poi visualizzato all'utente finale.}
}
