\subsection{Introduzione}
    ...
    \subsection{Attributi opzionali}
    
    	\par Nel caso un attributo possa essere omesso nella richiesta e/o risposta, verrà identificato con "(opzionale)" di fianco
    		al tipo dell'attributo.
        ...
        \begin{table}[H]
            \begin{center}
                \begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
                    ...
                    \textbf{Permessi} & Ospite    "explanation": string (opzionale), \\ \midrule
                    \textbf{Richiesta JSON} & \\ \midrule
                    \textbf{Risposta JSON} & \
                        \begin{lstlisting}[basicstyle={\ttfamily}]
{
