...
Al fine di rendere più chiare le relazioni principali del \mgls{package} \texttt{client::controller::student}, in seguito verranno riportati delle porzioni del diagramma delle classi del client, in particolare per evidenziare il rapporto con il \mgls{package} \texttt{client:model}.
...
Al fine di rendere più chiare le relazioni principali del \mgls{package} \texttt{client::controller::teacher}, in seguito verranno riportati delle porzioni del diagramma delle classi del client, in particolare per evidenziare il rapporto con il \mgls{package} \texttt{client:model}.
