\begin{longtable}{r l p{2cm} p{6cm} p{2cm}}
	...
	Opzionale & Il sistema deve mostrare allo studente la difficoltà del questionario calcolata come funzione delle risposte date da tutti gli utenti & \hyperlink{UC13.2}{UC13.2}
	...
	Obbligatorio & Il sistema deve permettere ad un docente di visualizzare una domanda & \hyperlink{UC17.10}{UC17.10}\tabularnewline
	\hline
	& \hypertarget{R-3F30}{R-3F30} & Funzionale
	
	Obbligatorio & Il sistema deve permettere ad un docente di visualizzare un questionario & \hyperlink{UC18.5}{UC18.5}\tabularnewline
	\hline
	& \hypertarget{R-3F31}{R-3F31} & Funzionale
	
	Obbligatorio & Il sistema deve gestire l'autenticazione di un utente nel sistema & \hyperlink{UC1}{UC1}\tabularnewline
	\hline
	\begin{tikzpicture}
	\draw [->, thick] (0.2,0.2) -- (0.2,0.1) -- (1,0.1);
	...
	\hyperlink{UC1.2}{UC1.2}\tabularnewline
	\hline
	\begin{tikzpicture}
	\draw [->, thick] (0.4,0.2) -- (0.4,0.1) -- (1,0.1);
