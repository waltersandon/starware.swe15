...
\begin{figure}[H]
	...
	\begin{resizedtikzpicture}{\textwidth}
		...
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			...
			\umlassoc{Docente}{43}
			\umlusecase[x=15, y=-11.25, fill=white, width=4cm, name=153]{\textbf{UC18.9:} Inserimento domanda a risposta aperta}
			\umlinherit{153}{43}
			\umlusecase[x=15, y=-6.75, fill=white, width=4cm, name=152]{\textbf{UC18.8:} Inserimento domanda con l'associazione di parole}
			\umlinherit{152}{43}
			\umlusecase[x=15, y=-2.25, fill=white, width=4cm, name=151]{\textbf{UC18.7:} Inserimento domanda di tipo testo con parole omesse}
			\umlinherit{151}{43}
			\umlusecase[x=15, y=2.25, fill=white, width=4cm, name=150]{\textbf{UC18.6:} Inserimento domanda a risposta multipla}
			\umlinherit{150}{43}
			\umlusecase[x=15, y=6.75, fill=white, width=4cm, name=149]{\textbf{UC18.5:} Inserimento domanda a scelta multipla}
			\umlinherit{149}{43}
			\umlusecase[x=15, y=11.25, fill=white, width=4cm, name=148]{\textbf{UC18.4:} Inserimento domanda di tipo vero/falso}
			\umlinherit{148}{43}
		\end{umlsystem}
	\end{resizedtikzpicture}
	\caption{\textbf{UC18.1}: Inserimento domanda}
...
\begin{figure}[H]
	...
	\begin{resizedtikzpicture}{\textwidth}
		...
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			...
			\umlassoc{Docente}{163}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=215]{\textbf{UC18.2.5:} Errore argomento mancante}
...
\begin{figure}[H]
	...
	\begin{resizedtikzpicture}{\textwidth}
		...
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=164]{\textbf{UC18.2.2:} Scrittura domanda in QML della domanda da modificare}
			\umlassoc{Docente}{164}
			\umlusecase[x=15, y=-2.25, fill=white, width=4cm, name=213]{\textbf{UC18.2.4:} Errore modifica QML non valido}
			...
			\umlusecase[x=15, y=2.25, fill=white, width=4cm, name=165]{\textbf{UC18.2.3:} Modifica domanda da interfaccia grafica}
			\umlinherit{165}{164}
		\end{umlsystem}
	\end{resizedtikzpicture}
