...
\begin{figure}[H]
	...
	\begin{resizedtikzpicture}{\textwidth}
		\umlactor[x=0, y=0]{Ospite}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=124]{\textbf{UC3.1:} Rispondi domanda}
			\umlassoc{Ospite}{124}
			\umlusecase[x=15, y=-11, fill=white, width=4cm, name=159]{\textbf{UC3.9:} Rispondi domanda a risposta aperta}
			\umlinherit{159}{124}
			\umlusecase[x=15, y=-6.5, fill=white, width=4cm, name=158]{\textbf{UC3.8:} Rispondi domanda con associazione di parole}
			\umlinherit{158}{124}
			\umlusecase[x=15, y=-2, fill=white, width=4cm, name=157]{\textbf{UC3.7:} Rispondi domanda di tipo testo con parole omesse}
			\umlinherit{157}{124}
			\umlusecase[x=15, y=2.5, fill=white, width=4cm, name=156]{\textbf{UC3.6:} Rispondi domanda a risposta multipla}
			\umlinherit{156}{124}
			\umlusecase[x=15, y=7, fill=white, width=4cm, name=155]{\textbf{UC3.5:} Rispondi domanda a scelta multipla}
			\umlinherit{155}{124}
			\umlusecase[x=15, y=11.25, fill=white, width=4cm, name=154]{\textbf{UC3.4:} Rispondi domanda vero/falso}
			\umlinherit{154}{124}
		\end{umlsystem}
	\end{resizedtikzpicture}
...
\begin{figure}[H]
	...
	\begin{resizedtikzpicture}{\textwidth}
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-4.5, fill=white, width=4cm, name=162]{\textbf{UC17.1.5:} Scrittura nuova domanda da interfaccia grafica}
			\umlassoc{Docente}{162}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=114]{\textbf{UC17.1.2:} Scrittura domanda in QML della nuova domanda}
			\umlassoc{Docente}{114}
			\umlusecase[x=5, y=4.5, fill=white, width=4cm, name=112]{\textbf{UC17.1.1:} Selezione argomenti nuova domanda}
...
\begin{figure}[H]
	...
	\begin{resizedtikzpicture}{\textwidth}
		...
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			...
			\umlassoc{Docente}{43}
			\umlusecase[x=15, y=-11.25, fill=white, width=4cm, name=153]{\textbf{UC17.9:} Inserimento domanda a risposta aperta}
			\umlinherit{153}{43}
			\umlusecase[x=15, y=-6.75, fill=white, width=4cm, name=152]{\textbf{UC17.8:} Inserimento domanda con l'associazione di parole}
			\umlinherit{152}{43}
			\umlusecase[x=15, y=-2.25, fill=white, width=4cm, name=151]{\textbf{UC17.7:} Inserimento domanda di tipo testo con parole omesse}
			\umlinherit{151}{43}
			\umlusecase[x=15, y=2.25, fill=white, width=4cm, name=150]{\textbf{UC17.6:} Inserimento domanda a risposta multipla}
			\umlinherit{150}{43}
			\umlusecase[x=15, y=6.75, fill=white, width=4cm, name=149]{\textbf{UC17.5:} Inserimento domanda a scelta multipla}
			\umlinherit{149}{43}
			\umlusecase[x=15, y=11.25, fill=white, width=4cm, name=148]{\textbf{UC17.4:} Inserimento domanda di tipo vero/falso}
			\umlinherit{148}{43}
		\end{umlsystem}
	\end{resizedtikzpicture}
	\caption{\textbf{UC17.1}: Inserimento domanda}
...
\subsection{Caso d'uso UC17.1.2: Scrittura domanda in QML della nuova domanda}
\begin{figure}[H]
	\centering
	\begin{resizedtikzpicture}{\textwidth}
		\umlactor[x=0, y=0]{Docente}
