...
\item[Scopo e descrizione:] Lo studente inserisce la sua vecchia password
 ...
 \begin{enumerate}
  ...
  \end{description}
\hypertarget{UC4.3.2}{}
\subsection{Caso d'uso UC4.3.2: Errore password non corrispondenti}\begin{description}
\item[Attori:] Studente;
...
\subsection{Caso d'uso UC18.2: Modifica domanda}
	...
	\begin{figure}[H]
		...
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=46]{\textbf{UC18.2:} Modifica domanda}
			\umlassoc{Docente}{46}
			\umlusecase[x=15, y=-2.25, fill=white, width=4cm, name=143]{\textbf{UC18.1.4:} Errore argomento mancante}
			\umlextend[name=ext-143-46]{143}{46}
			\umlnote[x=23, y=-2.25, fill=white, width=4cm, geometry=|-|, arm=-2cm]{ext-143-46-1}{Non è stato selezionato almeno un argomento}
			\umlusecase[x=15, y=2.5, fill=white, width=4cm, name=142]{\textbf{UC18.1.3:} Errore QML non valido}
			\umlextend[name=ext-142-46]{142}{46}
			\umlnote[x=23, y=2.5, fill=white, width=4cm, geometry=|-|, arm=-1.75cm]{ext-142-46-1}{Il QML non è valido}
		\end{umlsystem}
		\end{resizedtikzpicture}
		\caption{\textbf{UC18.2}: Modifica domanda}
		\label{UC18.2}
