...
\subsection{Caso d'uso UC3: Gestione profilo}
	\begin{figure}[H]
		...
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-4, fill=white, width=4cm, name=195]{\textbf{UC3.3:} Modifica password}
			\umlassoc{Utente}{195}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=175]{\textbf{UC3.2:} Modifica username}
			\umlassoc{Utente}{175}
			\umlusecase[x=5, y=4, fill=white, width=4cm, name=41]{\textbf{UC3.1:} Modifica nome completo}
			\umlassoc{Utente}{41}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC3.1: Modifica nome completo}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=41]{\textbf{UC3.1:} Modifica nome completo}
			\umlassoc{Utente}{41}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=197]{\textbf{UC3.5:} Errore nome completo troppo corto}
			\umlextend[name=ext-197-41]{197}{41}
			\umlnote[x=23, y=0, fill=white, width=4cm, geometry=|-|, arm=-2cm]{ext-197-41-1}{Il nome completo inserito dall'ospite è troppo corto
}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC3.2: Modifica username}
	\begin{figure}[H]
		...
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=175]{\textbf{UC3.2:} Modifica username}
			\umlassoc{Utente}{175}
			\umlusecase[x=15, y=-2.5, fill=white, width=4cm, name=198]{\textbf{UC3.6:} Errore username già utilizzato}
			\umlextend[name=ext-198-175]{198}{175}
			\umlnote[x=23, y=-2.5, fill=white, width=4cm, geometry=|-|, arm=-2.25cm]{ext-198-175-1}{L'utente ha inserito un username già utilizzato da qualche altro utente}
			\umlusecase[x=15, y=2.75, fill=white, width=4cm, name=196]{\textbf{UC3.4:} Errore username troppo corto}
			\umlextend[name=ext-196-175]{196}{175}
			\umlnote[x=23, y=2.75, fill=white, width=4cm, geometry=|-|, arm=-2cm]{ext-196-175-1}{L'username inserito dall'utente è troppo corto}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC3.3: Modifica password}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=207]{\textbf{UC3.3.1:} Inserimento vecchia password}
			\umlassoc{Utente}{207}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC3.3.1: Inserimento vecchia password}
	\begin{figure}[H]
		...
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=207]{\textbf{UC3.3.1:} Inserimento vecchia password}
			\umlassoc{Utente}{207}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=208]{\textbf{UC3.3.2:} Errore password non corrispondenti}
			\umlextend[name=ext-208-207]{208}{207}
			\umlnote[x=23, y=0, fill=white, width=4cm, geometry=|-|, arm=-2cm]{ext-208-207-1}{L'utente ha inserito la sua vecchia password ma è errata}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC3.3.2: Errore password non corrispondenti}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=208]{\textbf{UC3.3.2:} Errore password non corrispondenti}
			\umlassoc{Utente}{208}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC3.4: Errore username troppo corto}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=196]{\textbf{UC3.4:} Errore username troppo corto}
			\umlassoc{Utente}{196}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC3.5: Errore nome completo troppo corto}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=197]{\textbf{UC3.5:} Errore nome completo troppo corto}
			\umlassoc{Utente}{197}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC3.6: Errore username già utilizzato}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=198]{\textbf{UC3.6:} Errore username già utilizzato}
			\umlassoc{Utente}{198}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC3.7: Errore password troppo corta}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=199]{\textbf{UC3.7:} Errore password troppo corta}
			\umlassoc{Utente}{199}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC4: Logout}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=5]{\textbf{UC4:} Logout}
			\umlassoc{Utente}{5}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC5: Gestione domande}
	\begin{figure}[H]
		...
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-4, fill=white, width=4cm, name=50]{\textbf{UC5.3:} Elimina domanda}
			\umlassoc{Docente}{50}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=46]{\textbf{UC5.2:} Modifica domanda}
			\umlassoc{Docente}{46}
			\umlusecase[x=5, y=4, fill=white, width=4cm, name=43]{\textbf{UC5.1:} Inserimento domanda}
			\umlassoc{Docente}{43}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC5.1: Inserimento domanda}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-4.5, fill=white, width=4cm, name=162]{\textbf{UC5.1.3:} Scrittura nuova domanda da interfaccia grafica}
			\umlassoc{Docente}{162}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=114]{\textbf{UC5.1.2:} Scrittura domanda in QML della nuova domanda}
			\umlassoc{Docente}{114}
			\umlusecase[x=5, y=4.5, fill=white, width=4cm, name=112]{\textbf{UC5.1.1:} Selezione argomenti nuova domanda}
...
\subsection{Caso d'uso UC5.1.1: Selezione argomenti nuova domanda}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=112]{\textbf{UC5.1.1:} Selezione argomenti nuova domanda}
			\umlassoc{Docente}{112}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC5.1.3: Scrittura nuova domanda da interfaccia grafica}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=162]{\textbf{UC5.1.3:} Scrittura nuova domanda da interfaccia grafica}
			\umlassoc{Docente}{162}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC5.2: Modifica domanda}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-4.75, fill=white, width=4cm, name=165]{\textbf{UC5.2.3:} Modifica domanda da interfaccia grafica}
			\umlassoc{Docente}{165}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=164]{\textbf{UC5.2.2:} Scrittura domanda in QML della domanda da modificare}
			\umlassoc{Docente}{164}
			\umlusecase[x=5, y=4.75, fill=white, width=4cm, name=163]{\textbf{UC5.2.1:} Selezione argomenti modifica domanda}
...
\subsection{Caso d'uso UC5.2.1: Selezione argomenti modifica domanda}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=163]{\textbf{UC5.2.1:} Selezione argomenti modifica domanda}
			\umlassoc{Docente}{163}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC5.2.3: Modifica domanda da interfaccia grafica}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=165]{\textbf{UC5.2.3:} Modifica domanda da interfaccia grafica}
			\umlassoc{Docente}{165}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC5.3: Elimina domanda}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=50]{\textbf{UC5.3:} Elimina domanda}
			\umlassoc{Docente}{50}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=206]{\textbf{UC5.13:} Errore eliminazione domanda utilizzata}
...
\subsection{Caso d'uso UC5.4: Errore QML non valido}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=142]{\textbf{UC5.4:} Errore QML non valido}
...
\subsection{Caso d'uso UC5.5: Errore argomento mancante}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=143]{\textbf{UC5.5:} Errore argomento mancante}
...
\subsection{Caso d'uso UC5.6: Inserimento domanda di tipo vero/falso}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=148]{\textbf{UC5.6:} Inserimento domanda di tipo vero/falso}
...
\subsection{Caso d'uso UC5.7: Inserimento domanda a scelta multipla}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=149]{\textbf{UC5.7:} Inserimento domanda a scelta multipla}
...
\subsection{Caso d'uso UC5.8: Inserimento domanda a risposta multipla}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=150]{\textbf{UC5.8:} Inserimento domanda a risposta multipla}
...
\subsection{Caso d'uso UC5.9: Inserimento domanda di tipo testo con parole omesse}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=151]{\textbf{UC5.9:} Inserimento domanda di tipo testo con parole omesse}
...
\subsection{Caso d'uso UC5.10: Inserimento domanda con l'associazione di parole}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=152]{\textbf{UC5.10:} Inserimento domanda con l'associazione di parole}
...
\subsection{Caso d'uso UC5.11: Inserimento domanda a risposta aperta}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=153]{\textbf{UC5.11:} Inserimento domanda a risposta aperta}
...
\subsection{Caso d'uso UC5.12: Visualizza domanda}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=181]{\textbf{UC5.12:} Visualizza domanda}
...
\subsection{Caso d'uso UC5.13: Errore eliminazione domanda utilizzata}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=206]{\textbf{UC5.13:} Errore eliminazione domanda utilizzata}
...
\subsection{Caso d'uso UC6: Gestione questionari}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-4, fill=white, width=4cm, name=48]{\textbf{UC6.3:} Elimina questionario}
			\umlassoc{Docente}{48}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=47]{\textbf{UC6.2:} Modifica questionario}
			\umlassoc{Docente}{47}
			\umlusecase[x=5, y=4, fill=white, width=4cm, name=42]{\textbf{UC6.1:} Inserisci questionario}
			\umlassoc{Docente}{42}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC6.1: Inserisci questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-4.5, fill=white, width=4cm, name=118]{\textbf{UC6.1.3:} Seleziona argomenti del nuovo questionario}
			\umlassoc{Docente}{118}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=93]{\textbf{UC6.1.2:} Elimina domanda da un nuovo questionario}
			\umlassoc{Docente}{93}
			\umlusecase[x=5, y=4.5, fill=white, width=4cm, name=91]{\textbf{UC6.1.1:} Aggiungi domanda in un nuovo questionario }
			\umlassoc{Docente}{91}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC6.1.1: Aggiungi domanda in un nuovo questionario }
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=91]{\textbf{UC6.1.1:} Aggiungi domanda in un nuovo questionario }
			\umlassoc{Docente}{91}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC6.1.3: Seleziona argomenti del nuovo questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=118]{\textbf{UC6.1.3:} Seleziona argomenti del nuovo questionario}
			\umlassoc{Docente}{118}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC6.2: Modifica questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-4.5, fill=white, width=4cm, name=168]{\textbf{UC6.2.3:} Selezione argomenti modifica questionario}
			\umlassoc{Docente}{168}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=167]{\textbf{UC6.2.2:} Elimina domanda da un questionario da  modificare}
			\umlassoc{Docente}{167}
			\umlusecase[x=5, y=4.5, fill=white, width=4cm, name=166]{\textbf{UC6.2.1:} Aggiungi domanda in un questionario}
...
\subsection{Caso d'uso UC6.2.1: Aggiungi domanda in un questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=166]{\textbf{UC6.2.1:} Aggiungi domanda in un questionario}
			\umlassoc{Docente}{166}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC6.2.3: Selezione argomenti modifica questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=168]{\textbf{UC6.2.3:} Selezione argomenti modifica questionario}
			\umlassoc{Docente}{168}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC6.3: Elimina questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=48]{\textbf{UC6.3:} Elimina questionario}
			\umlassoc{Docente}{48}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC6.4: Errore questionario vuoto}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=144]{\textbf{UC6.4:} Errore questionario vuoto}
...
\subsection{Caso d'uso UC6.5: Visualizza questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=182]{\textbf{UC6.5:} Visualizza questionario}
...
\subsection{Caso d'uso UC7: Gestione classi}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-4, fill=white, width=4cm, name=49]{\textbf{UC7.3:} Elimina classe}
			\umlassoc{Docente}{49}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=45]{\textbf{UC7.2:} Modifica classe}
			\umlassoc{Docente}{45}
			\umlusecase[x=5, y=4, fill=white, width=4cm, name=44]{\textbf{UC7.1:} Inserisci classe}
			\umlassoc{Docente}{44}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC7.1: Inserisci classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-4, fill=white, width=4cm, name=95]{\textbf{UC7.1.3:} Inserisci password classe}
			\umlassoc{Docente}{95}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=94]{\textbf{UC7.1.2:} Inserisci argomenti classe}
			\umlassoc{Docente}{94}
			\umlusecase[x=5, y=4, fill=white, width=4cm, name=90]{\textbf{UC7.1.1:} Inserisci nome classe}
			\umlassoc{Docente}{90}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC7.1.1: Inserisci nome classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=90]{\textbf{UC7.1.1:} Inserisci nome classe}
			\umlassoc{Docente}{90}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=92]{\textbf{UC7.4:} Errore nome classe già presente}
...
\subsection{Caso d'uso UC7.1.3: Inserisci password classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=95]{\textbf{UC7.1.3:} Inserisci password classe}
			\umlassoc{Docente}{95}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC7.3: Elimina classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=49]{\textbf{UC7.3:} Elimina classe}
			\umlassoc{Docente}{49}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC7.4: Errore nome classe già presente}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=92]{\textbf{UC7.4:} Errore nome classe già presente}
			\umlassoc{Docente}{92}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC8: Gestione argomenti}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-6, fill=white, width=4cm, name=146]{\textbf{UC8.5:} Eliminazione argomento}
			\umlassoc{Docente}{146}
			\umlusecase[x=5, y=-2, fill=white, width=4cm, name=141]{\textbf{UC8.4:} Modifica argomento}
			\umlassoc{Docente}{141}
			\umlusecase[x=5, y=2, fill=white, width=4cm, name=137]{\textbf{UC8.2:} Crea argomento}
			\umlassoc{Docente}{137}
			\umlusecase[x=5, y=6, fill=white, width=4cm, name=135]{\textbf{UC8.1:} Esplorazione argomenti}
...
\subsection{Caso d'uso UC8.1: Esplorazione argomenti}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=135]{\textbf{UC8.1:} Esplorazione argomenti}
			\umlassoc{Docente}{135}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC8.2: Crea argomento}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=137]{\textbf{UC8.2:} Crea argomento}
			\umlassoc{Docente}{137}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=140]{\textbf{UC8.3:} Argomento già presente nel sistema}
...
\subsection{Caso d'uso UC8.3: Argomento già presente nel sistema}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=140]{\textbf{UC8.3:} Argomento già presente nel sistema}
...
\subsection{Caso d'uso UC8.4: Modifica argomento}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=141]{\textbf{UC8.4:} Modifica argomento}
			\umlassoc{Docente}{141}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=140]{\textbf{UC8.3:} Argomento già presente nel sistema}
...
\subsection{Caso d'uso UC8.5: Eliminazione argomento}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=146]{\textbf{UC8.5:} Eliminazione argomento}
			\umlassoc{Docente}{146}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=147]{\textbf{UC8.6:} Errore l'argomento ha domande o questionari}
...
\subsection{Caso d'uso UC8.6: Errore l'argomento ha domande o questionari}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=147]{\textbf{UC8.6:} Errore l'argomento ha domande o questionari}
...
\subsection{Caso d'uso UC9: Visualizza statistiche}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=10]{\textbf{UC9:} Visualizza statistiche}
			\umlassoc{Docente}{10}
			\umlusecase[x=15, y=-4.25, fill=white, width=4cm, name=13]{\textbf{UC12:} Visualizza statistiche classe}
			\umlinherit{13}{10}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=12]{\textbf{UC11:} Visualizza statistiche questionario}
			\umlinherit{12}{10}
			\umlusecase[x=15, y=4.25, fill=white, width=4cm, name=11]{\textbf{UC10:} Visualizza statistiche domanda}
			\umlinherit{11}{10}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC10: Visualizza statistiche domanda}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=11]{\textbf{UC10:} Visualizza statistiche domanda}
			\umlassoc{Docente}{11}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC11: Visualizza statistiche questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=12]{\textbf{UC11:} Visualizza statistiche questionario}
			\umlassoc{Docente}{12}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC12: Visualizza statistiche classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-6.75, fill=white, width=4cm, name=110]{\textbf{UC12.4:} Visualizza statistiche studente della classe}
			\umlassoc{Docente}{110}
			\umlusecase[x=5, y=-2.25, fill=white, width=4cm, name=109]{\textbf{UC12.3:} Visualizza sommario statistiche classe}
			\umlassoc{Docente}{109}
			\umlusecase[x=5, y=2.25, fill=white, width=4cm, name=108]{\textbf{UC12.2:} Visualizza risultati questionari della classe}
			\umlassoc{Docente}{108}
			\umlusecase[x=5, y=6.75, fill=white, width=4cm, name=107]{\textbf{UC12.1:} Visualizza risultati domande della classe}
...
\subsection{Caso d'uso UC12.1: Visualizza risultati domande della classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=107]{\textbf{UC12.1:} Visualizza risultati domande della classe}
			\umlassoc{Docente}{107}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC12.2: Visualizza risultati questionari della classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=108]{\textbf{UC12.2:} Visualizza risultati questionari della classe}
			\umlassoc{Docente}{108}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC12.3: Visualizza sommario statistiche classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=109]{\textbf{UC12.3:} Visualizza sommario statistiche classe}
			\umlassoc{Docente}{109}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC12.4: Visualizza statistiche studente della classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=111]{\textbf{UC12.4.1:} Visualizza risultati questionari dello studente}
...
\subsection{Caso d'uso UC13: Esegui questionario}
	\begin{figure}[H]
		...
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-6.25, fill=white, width=4cm, name=132]{\textbf{UC13.3:} Conferma questionario}
			\umlassoc{Studente}{132}
			\umlusecase[x=5, y=-2, fill=white, width=4cm, name=205]{\textbf{UC13.11:} Visualizza valutazione questionario}
			\umlassoc{Studente}{205}
			\umlusecase[x=5, y=2.25, fill=white, width=4cm, name=160]{\textbf{UC13.10:} Feedback questionario}
			\umlassoc{Studente}{160}
			\umlusecase[x=5, y=6.25, fill=white, width=4cm, name=124]{\textbf{UC13.1:} Rispondi domanda}
...
\subsection{Caso d'uso UC13.1: Rispondi domanda}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=124]{\textbf{UC13.1:} Rispondi domanda}
			\umlassoc{Studente}{124}
			\umlusecase[x=15, y=-11, fill=white, width=4cm, name=159]{\textbf{UC13.9:} Rispondi domanda a risposta aperta}
			\umlinherit{159}{124}
			\umlusecase[x=15, y=-6.5, fill=white, width=4cm, name=158]{\textbf{UC13.8:} Rispondi domanda con associazione di parole}
			\umlinherit{158}{124}
			\umlusecase[x=15, y=-2, fill=white, width=4cm, name=157]{\textbf{UC13.7:} Rispondi domanda di tipo testo con parole omesse}
			\umlinherit{157}{124}
			\umlusecase[x=15, y=2.5, fill=white, width=4cm, name=156]{\textbf{UC13.6:} Rispondi domanda a risposta multipla}
			\umlinherit{156}{124}
			\umlusecase[x=15, y=7, fill=white, width=4cm, name=155]{\textbf{UC13.5:} Rispondi domanda a scelta multipla}
			\umlinherit{155}{124}
			\umlusecase[x=15, y=11.25, fill=white, width=4cm, name=154]{\textbf{UC13.4:} Rispondi domanda vero/falso}
			\umlinherit{154}{124}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC13.2: Errore domanda non risposta}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=125]{\textbf{UC13.2:} Errore domanda non risposta}
...
\subsection{Caso d'uso UC13.3: Conferma questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=132]{\textbf{UC13.3:} Conferma questionario}
			\umlassoc{Studente}{132}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=125]{\textbf{UC13.2:} Errore domanda non risposta}
...
\subsection{Caso d'uso UC13.4: Rispondi domanda vero/falso}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=154]{\textbf{UC13.4:} Rispondi domanda vero/falso}
...
\subsection{Caso d'uso UC13.5: Rispondi domanda a scelta multipla}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=155]{\textbf{UC13.5:} Rispondi domanda a scelta multipla}
...
\subsection{Caso d'uso UC13.6: Rispondi domanda a risposta multipla}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=156]{\textbf{UC13.6:} Rispondi domanda a risposta multipla}
...
\subsection{Caso d'uso UC13.7: Rispondi domanda di tipo testo con parole omesse}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=157]{\textbf{UC13.7:} Rispondi domanda di tipo testo con parole omesse}
...
\subsection{Caso d'uso UC13.8: Rispondi domanda con associazione di parole}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=158]{\textbf{UC13.8:} Rispondi domanda con associazione di parole}
...
\subsection{Caso d'uso UC13.9: Rispondi domanda a risposta aperta}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=159]{\textbf{UC13.9:} Rispondi domanda a risposta aperta}
...
\subsection{Caso d'uso UC13.10: Feedback questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=160]{\textbf{UC13.10:} Feedback questionario}
			\umlassoc{Studente}{160}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC13.11: Visualizza valutazione questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=205]{\textbf{UC13.11:} Visualizza valutazione questionario}
			\umlassoc{Studente}{205}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC14: Iscrizione ad una classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=97]{\textbf{UC14.1:} Inserisci password classe}
...
\subsection{Caso d'uso UC14.1: Inserisci password classe}
	\begin{figure}[H]
		...
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=97]{\textbf{UC14.1:} Inserisci password classe}
			\umlassoc{Studente}{97}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=98]{\textbf{UC14.2:} Errore password classe}
...
\subsection{Caso d'uso UC14.2: Errore password classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=98]{\textbf{UC14.2:} Errore password classe}
...
\subsection{Caso d'uso UC15: Visualizza storico studente}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=-4.5, fill=white, width=4cm, name=139]{\textbf{UC15.3:} Visualizza sommario statistiche studente}
			\umlassoc{Studente}{139}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=138]{\textbf{UC15.2:} Visualizza statistiche questionari studente}
			\umlassoc{Studente}{138}
			\umlusecase[x=5, y=4.5, fill=white, width=4cm, name=136]{\textbf{UC15.1:} Visualizza statistiche domande studente}
...
\subsection{Caso d'uso UC15.1: Visualizza statistiche domande studente}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=136]{\textbf{UC15.1:} Visualizza statistiche domande studente}
			\umlassoc{Studente}{136}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC15.3: Visualizza sommario statistiche studente}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=139]{\textbf{UC15.3:} Visualizza sommario statistiche studente}
			\umlassoc{Studente}{139}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC16: Ricerca questionario}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=17]{\textbf{UC16:} Ricerca questionario}
			\umlassoc{Utente}{17}
			\umlusecase[x=15, y=-8, fill=white, width=4cm, name=22]{\textbf{UC21:} Ricerca questionario per difficoltà}
			\umlinherit{22}{17}
			\umlusecase[x=15, y=-3.75, fill=white, width=4cm, name=21]{\textbf{UC20:} Ricerca questionario per docente}
			\umlinherit{21}{17}
			\umlusecase[x=15, y=0.25, fill=white, width=4cm, name=20]{\textbf{UC19:} Ricerca questionario per argomento}
			\umlinherit{20}{17}
			\umlusecase[x=15, y=4.25, fill=white, width=4cm, name=19]{\textbf{UC18:} Ricerca questionario per classe}
			\umlinherit{19}{17}
			\umlusecase[x=15, y=8.25, fill=white, width=4cm, name=18]{\textbf{UC17:} Ricerca questionario per titolo}
			\umlinherit{18}{17}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC17: Ricerca questionario per titolo}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=18]{\textbf{UC17:} Ricerca questionario per titolo}
			\umlassoc{Utente}{18}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC18: Ricerca questionario per classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=19]{\textbf{UC18:} Ricerca questionario per classe}
			\umlassoc{Utente}{19}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC19: Ricerca questionario per argomento}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=20]{\textbf{UC19:} Ricerca questionario per argomento}
			\umlassoc{Utente}{20}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC20: Ricerca questionario per docente}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=21]{\textbf{UC20:} Ricerca questionario per docente}
			\umlassoc{Utente}{21}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC21: Ricerca questionario per difficoltà}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=22]{\textbf{UC21:} Ricerca questionario per difficoltà}
			\umlassoc{Utente}{22}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC22: Ricerca domanda}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=23]{\textbf{UC22:} Ricerca domanda}
			\umlassoc{Docente}{23}
			\umlusecase[x=15, y=-6, fill=white, width=4cm, name=27]{\textbf{UC26:} Ricerca domanda per docente}
			\umlinherit{27}{23}
			\umlusecase[x=15, y=-2, fill=white, width=4cm, name=26]{\textbf{UC25:} Ricerca domanda per difficoltà}
			\umlinherit{26}{23}
			\umlusecase[x=15, y=2, fill=white, width=4cm, name=25]{\textbf{UC24:} Ricerca domanda per argomento}
			\umlinherit{25}{23}
			\umlusecase[x=15, y=6, fill=white, width=4cm, name=24]{\textbf{UC23:} Ricerca domanda per keywords}
			\umlinherit{24}{23}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC23: Ricerca domanda per keywords}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=24]{\textbf{UC23:} Ricerca domanda per keywords}
			\umlassoc{Docente}{24}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC24: Ricerca domanda per argomento}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=25]{\textbf{UC24:} Ricerca domanda per argomento}
			\umlassoc{Docente}{25}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC25: Ricerca domanda per difficoltà}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=26]{\textbf{UC25:} Ricerca domanda per difficoltà}
			\umlassoc{Docente}{26}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC26: Ricerca domanda per docente}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Docente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=27]{\textbf{UC26:} Ricerca domanda per docente}
			\umlassoc{Docente}{27}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC27: Ricerca classe}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=28]{\textbf{UC27:} Ricerca classe}
			\umlassoc{Studente}{28}
			\umlusecase[x=15, y=-2, fill=white, width=4cm, name=30]{\textbf{UC29:} Ricerca classe per argomento}
			\umlinherit{30}{28}
			\umlusecase[x=15, y=2, fill=white, width=4cm, name=29]{\textbf{UC28:} Ricerca classe per docente}
			\umlinherit{29}{28}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC28: Ricerca classe per docente}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=29]{\textbf{UC28:} Ricerca classe per docente}
...
\subsection{Caso d'uso UC29: Ricerca classe per argomento}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Studente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=30]{\textbf{UC29:} Ricerca classe per argomento}
...
\subsection{Caso d'uso UC30.1: Cambia ruolo}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Amministratore}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=34]{\textbf{UC30.1:} Cambia ruolo}
			\umlassoc{Amministratore}{34}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC30.2: Rimozione utente}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Amministratore}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=35]{\textbf{UC30.2:} Rimozione utente}
			\umlassoc{Amministratore}{35}
		\end{umlsystem}
		\end{resizedtikzpicture}
...
\subsection{Caso d'uso UC33: Ricerca utente per username}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Amministratore}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=203]{\textbf{UC33:} Ricerca utente per username}
...
\subsection{Caso d'uso UC34: Ricerca utente per ruolo}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Amministratore}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=204]{\textbf{UC34:} Ricerca utente per ruolo}
...
\subsection{Caso d'uso UC35: Recupero password}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Utente}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=209]{\textbf{UC35:} Recupero password}
			\umlassoc{Utente}{209}
			\umlusecase[x=15, y=0, fill=white, width=4cm, name=210]{\textbf{UC35.1:} Errore mail per recupero password non presente}
...
\subsection{Caso d'uso UC35.1: Errore mail per recupero password non presente}
	\begin{figure}[H]
		...
		\umlactor[x=0, y=0]{Ospite}
		\begin{umlsystem}[x=0, fill=lightgray!20]{Quizzipedia}
			\umlusecase[x=5, y=0, fill=white, width=4cm, name=210]{\textbf{UC35.1:} Errore mail per recupero password non presente}
			\umlassoc{Ospite}{210}
		\end{umlsystem}
		\end{resizedtikzpicture}
