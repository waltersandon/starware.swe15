...
\paragraph{Pull}
È preferibile fare un \texttt{git pull} ogni volta che si comincia a lavorare da locale. Si raccomanda di controllare sempre il \textit{branch} a cui si sta lavorando
\paragraph{Push}
