...
Il \PM{} deve convocare la riunione attraverso la creazione di un \textit{\mgls{ticket}} su \textit{\mgls{Teamwork}} avente le caratteristiche descritte nella sezione 6.5.1.5 di questo documento.
...
\begin{center}
	\begin{figure}[H]
		...
		\includegraphics[scale=0.5]{TicketCicloVita.png}
...
\begin{center}
	...
	\end{figure}
\end{center}
\subsubsubsection{Ticket di Riunione}
assegnato a tutti i membri del gruppo, avente le seguenti caratteristiche:
 \begin{itemize}
