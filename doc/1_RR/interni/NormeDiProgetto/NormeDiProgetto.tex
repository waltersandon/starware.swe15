...
documenti, i termini tecnici, di dominio, gli acronimi e le parole che necessitano chiarimenti sono riportate nel documento \emph{Glossario\_v1.2.0}. Ogni occorrenza di vocaboli presenti nel \GlO{} è marcata da una G maiuscola in pedice (e.g. pedice\textsubscript{G}).
...
\begin{itemize}
  \item permette di creare diagrammi di \mGls{gantt} e di \mGls{pert} in maniera facile ed intuitiva;
