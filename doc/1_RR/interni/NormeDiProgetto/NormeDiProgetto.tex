...
\begin{itemize}
	...
	\item \textbf{Inspection:} l'\mgls{inspection} si basa sulla lettura mirata dei documenti/codice. Durante tale lettura si cercano gli errori segnalati nella \mgls{lista di controllo}. Progressivamente, con l'acquisizione di esperienza e grazie al precedente uso della tecnica di \mgls{walkthrough}, la \mgls{lista di controllo} viene estesa e specializzata, rendendo l'\mgls{inspection} sempre più efficace;
\end{itemize}
