...
\begin{itemize}
	...
	\item \textbf{Segnalazione degli errori riscontrati:} Attenendosi a quanto riportato nella tabella \ref{tabCalssificazioneProb} il \VR{} deve generare dei \textit{\mglspl{ticket}} secondo quando descritto nella sezione \TODO{}
\end{itemize}
...
Se un membro del gruppo riscontra un problema durante l'utilizzo del software dovrà aprire un \textit{\mgls{task}} con titolo:
\begin{center}
...
Ogni verbale redatto dovrà essere allegato al \mgls{task} della riunione creato su \textit{\glossary{Asana}} e dovrà essere nominato \fileName{verbale\_data}, la data seve seguire il formato indicato nella sezione 3.3.5.3.
