...
\begin{itemize}
	...
	\item \textbf{Calcolo dell’indice \mgls{gulpease}:} Su ogni documento redatto il \VR\ deve calcolare l’indice di leggibilità. Per fare ciò segnala l'utilizzo del applicazione web \url{http://labs.translated.net/leggibilita-testo/} \TODO{mettere script}. Nel caso in cui il testo risultasse difficile, sarà necessario eseguire un \mgls{walkthrough} del documento alla ricerca delle frasi troppo lunghe o complesse
...
\TODO{user case a mano}

\TODO{requisiti minimi verificati}
