...
\TODO{label a projectliber e link e paragrafo}
...
\begin{itemize}
	...
	\item calcola i parametri \textit{\mGls{Schedule Variance}} (SV) e \textit{\mGls{Cost Variance}} (CV);
...
\mgls{projectlibre} viene anche utilizzato come strumento di controllo in quanto permette di calcolare automaticamente le metriche di \textit{\mGls{Schedule Variance}} e \textit{\mGls{Cost Variance}}. Per far ciò il Responsabile deve modificare i progetti creati nel modo seguente:
\begin{enumerate}
