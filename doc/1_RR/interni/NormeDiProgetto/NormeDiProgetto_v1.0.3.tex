...
Per le comunicazioni interne informali è stato scelto l’uso di \gloss{Telegram}, per il suo utilizzo tramite \gloss{browser} che permette, quindi, un accesso alle conversazioni sia da pc che da \gloss{smartphone}.
Per lo scambio e la condivisione di file e appunti è invece utilizzato il servizio cloud di \gloss{Google Drive}. Inoltre è permesso l’uso di \gloss{Skype} per effettuare conferenze di gruppo o anche tra singoli membri di esso.
