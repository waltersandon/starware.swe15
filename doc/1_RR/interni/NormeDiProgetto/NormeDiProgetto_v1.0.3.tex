...
\end{enumerate}
Per lo scopo del corrente progetto saranno dettate solo le norme per le fasi di fornitura e sviluppo, poiché la prima fase riguarda l’acquirente e i processi operativi e di manutenzione non verranno trattati.
...
\end{itemize}
\begin{itemize}
\item Codice è un numero progressivo univoco per ogni requisito, indipendente da importanza e tipo. Codice può anche essere espresso in modo gerarchico per esprimere un sottorequisito tramite la notazione \textit{CodiceRequistoPadre.CodiceSottorequisito}
\end{itemize}
Ogni requisito deve essere correlato da una sintetica ma precisa descrizione

\paragraph{Casi d'uso}
I casi d'uso sono creati secondo lo standard UML 2.0 e sono i dentificati con la seguente notazione:
\begin{center}
UC[codice]
\end{center}
