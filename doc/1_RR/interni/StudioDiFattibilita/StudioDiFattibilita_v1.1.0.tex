...
Per questo capitolato è richiesta l'implementazione di un'applicazione per \textit{smartphone}. L'applicazione deve permettere di gestire la micro-localizzazione dove è presente la tecnologia BLE Beacon, e veicolare al utente finale informazioni contestuali a questi luoghi. 
