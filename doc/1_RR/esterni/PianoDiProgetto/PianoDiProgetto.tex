...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{p{0.08\textwidth} p{0.4\textwidth} p{0.2\textwidth} p{0.1\textwidth}}
			...
			\textbf{PA5} & \textbf{Specifica Tecnica} & &  \\ \midrule
			PA5.1 & Stesura & \PG & 59 \\ \midrule
			PA5.2 & Verifica & \VR & 20 \\ \midrule
			\textbf{PA6} & \textbf{Definizione di Prodotto} & &  \\ \midrule
...
\newpage
\section{Pianificazione di dettaglio e codifica} % 12/04/16 al 16/05/16 => 24 ore di lavoro a testa
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{p{0.08\textwidth} p{0.4\textwidth} p{0.2\textwidth} p{0.1\textwidth}}
			...
			\textbf{PDC5} & \textbf{Specifica Tecnica} & & \\ \midrule
			PDC5.1 & Incremento & \PG & 8 \\ \midrule
			PDC5.2 & Verifica & \VR & 2 \\ \midrule
			\textbf{PDC6} & \textbf{Definizione di Prodotto} & & \\ \midrule
			...
			\textbf{PDC8} & \textbf{Manuale Utente} & & \\ \midrule
			PDC8.1 & Stesura & \AM \newline \PG & 1 \newline 5 \\ \midrule
