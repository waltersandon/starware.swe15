...
\begin{itemize}
	\item \textbf{\mgls{quality assurance}:} Per garantire il raggiungimento della qualità del prodotto si prevede l'utilizzo delle tecniche di analisi statica e dinamica, descritte nella sezione \ref{analisi}. In particolare, anche i test devono rispecchiare l'approccio \mgls{bottom-up} di analisi
...
\begin{itemize}
	\item \textbf{\mgls{schedule variance}:} 0\% (indice entro il range di ottimale)
	\item \textbf{\mgls{cost variance}:} 0,5\% (indice entro il range di ottimale)
\end{itemize}
