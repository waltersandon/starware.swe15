...
\subparagraph{Metodi preventivi:}
\begin{itemize}
	\item Strumenti di condivisione: per rendere chiaro lo stato di avanzamento e tenere traccia di quest'ultimo in modo automatico e chiaro. Vedi \NdP{}.
	\item Strumenti di pianificazione: per la gestione controllata delle risorse umane e non. Vedi \NdP{}.
\end{itemize}
...
\subparagraph{Metodi preventivi:}
I metodi organizzativi adottati ed esposti in \NdP\ impongono la suddivisione dei compiti in task, e l'assegnazione da parte del \PM di questi ultimi alle risorse disponibili, in maniera preventiva e documentata. 
...
\begin{itemize}
	...
	\item Misurazione di \mgls{cost variance} e \mgls{schedule variance} e analisi dei dati.\ref{metriche_processi}	
\end{itemize}
...
Gli obiettivi che fanno capo alla documentazione sono riconducibili agli obiettivi di \textit{manutenibilità} e di \textit{qualità di processo}.
