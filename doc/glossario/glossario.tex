...
\newglossaryentry{analisi} {
	name=analisi,
	description={è il periodo di preparazione e produzioni di documenti che precede la \mGls{Revisione dei requisiti}}
}

\newglossaryentry{progettazione} {
	name=progettazione,
	description={è il periodo che intercorre tra la \mGls{Revisione dei requisiti} e la \mGls{Revisione di progettazione}}
}

\newglossaryentry{codifica} {
	name=codifica,
	description={è il periodo che intercorre tra \mGls{la Revisione di progettazione} e la \mGls{Revisione di qualifica}}
}

\newglossaryentry{validazione} {
	name=validazione,
	description={è il periodo che intercorre tra la \mGls{Revisione di qualifica} e la \mGls{Revisione di accettazione}}
}
...
\newglossaryentry{quality assurance} {
	...
	description={è l'insieme delle \mgls{attività} volte a garantire il soddisfacimento degli obiettivi della qualità}
}
...
\newglossaryentry{subtask} {
	name=subtask,
	description={è un task compreso all'interno di un altro \mgls{task}. La totalità di tutti i subtasks costituisce un intero \mgls{task}}
	plural=subtasks
}

\newglossaryentry{ticketing} {
	name=ticketing,
	description={procedura con la quale il \mGls{Responsabile} assegna un \mgls{task}}
}
...
\newglossaryentry{postgresql} {
	name=PostgreSQL,
	description={e un sistema di gestione di basi di dati \mgls{open-source} usato per applicazioni che richiedono caratteristiche molto complesse complesse}
}
...
\newglossaryentry{github} {
	name=Github,
	description={è un servizio \mgls{open-source} basato su \mgls{git}. Per maggiori informazioni si veda \href{https://github.com}{qui}}
}
...
\newglossaryentry{push} {
	name=push,
	description={per inviare modifiche di un documento site in un host locale al \mgls{repository} remoto. Per maggiori informazioni si veda \href{https://git-scm.com/docs/}{qui}}
}
...
\newglossaryentry{pull} {
	name=pull,
	description={un comando \mgls{gitub} per poter ricevere nel locale tutte le modifiche fatte nel \mgls{repository} remoto. Per maggiori informazioni si veda \href{https://git-scm.com/docs/}{qui}}
}
