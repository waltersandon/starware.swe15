...
describe('Execute Questionnaire', function() {
    ...
    it('studente deve poter eseguire un questionario Quiz 2', function () {
     ...
     if(OI){
         ...
         browser.actions().dragAndDrop(lost,list.get(0)).perform();
         browser.actions().dragAndDrop(breakingBad,list.get(1)).perform();
         browser.actions().dragAndDrop(gameOfThrones,list.get(2)).perform();
