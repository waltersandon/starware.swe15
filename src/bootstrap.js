...
mongoose.connect(config.dbUri, function() {
	...
	Promise.all([
		...
		var usr2 = new User ({fullName:'Carlo Bianchi', password: 'password', role: student._id, userName: "cbianchi" });
		var usr3 = new User ({fullName:'Amilcare Verdi', password: 'password', role: student._id, userName: "averdi" });
		var usr4 = new User ({fullName:'Mariuccia Pastafrolla', password: 'password', role: student._id, userName: "mpastafrolla" });

		var question1 = new Question ({author: usr2._id, body: 'domanda Matematica', tags: [tag1._id]});
		var question2 = new Question ({author: usr3._id, body: 'domanda Informatica', tags: [tag2._id]});
		var question3 = new Question ({author: usr4._id, body: 'domanda Italiano', tags: [tag3._id]});
