...
mongoose.connect(config.dbUri, function() {
	...
	Promise.all([
		...
		var question3 = new Question ({author: usr4._id, body: "<MC>\nQuanto fa 3 + 5?\n[answers]\n() 7\n(*) 8\n() 9", tags: [tag1._id]});
		var question4 = new Question ({author: usr3._id, body: "<MC>\nQuale di questi numeri è primo?\n[answers]\n() 15\n(*) 2\n() 21", tags: [tag1._id]});
		var question5 = new Question ({author: usr3._id, body: "<MC>\nChi ha scritto il Decameron\n[answers]\n() Dante\n() Petrarca\n(*) Boccaccio\n() D'annunzio", tags: [tag3._id]});
		...
		var question7 = new Question ({author: usr5._id, body: "<MC>\nChi di questi è più ricco?\n[answers]\n" +
